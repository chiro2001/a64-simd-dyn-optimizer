...
- **DCT32 op 后端 best = 4002 fused_uop**（vector 4466 / 零 scatter，
  相对上游 12710 = 0.315×，**低于内部参考 fused_uop 4827 = 0.829×、
  fused_adj 4251 = 0.941×**），
  **TestBenchLite 5 seed 全 PASS（黄金标准闭合）**；由
  row_group=16 合并存储 + k0_merge8 + k0 先发射 + pass1 专用
  k0 E-pack + **indexed sdot 常量共享 + odd/k2/k4 切片复用 k0 pack
  （pass1+pass2）**达成（5390→4002，-25.7%），
