...
- **luma vpp 24x32**：937/549，20k 差分 0 失配（SVE2）。
- **luma vpp 12x16**：247/158，20k 差分 0 失配（SVE2）。
...
- **chroma.copy_sp 16x16**：48/31，20k 差分 0 失配（SVE2）。
- **chroma.copy_ps 16x16**：32/26，20k 差分 0 失配（SVE2）。
