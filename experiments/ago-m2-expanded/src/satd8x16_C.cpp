...
extern "C" int dynopt_ago_satd8x16(const uint8_t* pix1, intptr_t stride1,
                  const uint8_t* pix2, intptr_t stride2)
{
    ...
    d[8] = vreinterpretq_s16_u16(vsubl_u8(vld1_u8(pix1 + 8 * stride1), vld1_u8(pix2 + 8 * stride2)));
    d[9] = vreinterpretq_s16_u16(vsubl_u8(vld1_u8(pix1 + 9 * stride1), vld1_u8(pix2 + 9 * stride2)));
    d[10] = vreinterpretq_s16_u16(vsubl_u8(vld1_u8(pix1 + 10 * stride1), vld1_u8(pix2 + 10 * stride2)));
    d[11] = vreinterpretq_s16_u16(vsubl_u8(vld1_u8(pix1 + 11 * stride1), vld1_u8(pix2 + 11 * stride2)));
    d[12] = vreinterpretq_s16_u16(vsubl_u8(vld1_u8(pix1 + 12 * stride1), vld1_u8(pix2 + 12 * stride2)));
    d[13] = vreinterpretq_s16_u16(vsubl_u8(vld1_u8(pix1 + 13 * stride1), vld1_u8(pix2 + 13 * stride2)));
    d[14] = vreinterpretq_s16_u16(vsubl_u8(vld1_u8(pix1 + 14 * stride1), vld1_u8(pix2 + 14 * stride2)));
    d[15] = vreinterpretq_s16_u16(vsubl_u8(vld1_u8(pix1 + 15 * stride1), vld1_u8(pix2 + 15 * stride2)));
    int16x8_t ta[4];
    hadamard_4_v(d + 0, ta);
