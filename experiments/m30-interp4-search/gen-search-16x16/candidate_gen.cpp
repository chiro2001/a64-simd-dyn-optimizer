...
extern "C" void dynopt_interp4_16x16_sve2(const uint8_t* src, intptr_t srcStride, uint8_t* dst, intptr_t dstStride, int coeffIdx)
{
    ...
    const svint16_t f16 = svld1_s16(pg8h, CTBL[ph]);
    ...
    for (int r = 0; r < 16; r++)
    {
        for (int g = 0; g < 2; g++)
        {
            svuint8_t s = svld1_u8(pg16b, src + r * srcStride -1 + g * 8);
