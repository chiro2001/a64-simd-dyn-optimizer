...
// pack=2 packed SATD 8x32 lowering)
#include <arm_sve.h>
                  ...
                  const uint8_t* pix2, intptr_t sp2)
{
    ...
    {
        // rows 0..3 in lanes 0..7, rows 16..19 in 8..15
        PD(p0, 0, 16);
        PD(p1, 1, 17);
        PD(p2, 2, 18);
        PD(p3, 3, 19);
    ...
    {
        // rows 4..7 in lanes 0..7, rows 20..23 in 8..15
        PD(p0, 4, 20);
        PD(p1, 5, 21);
        PD(p2, 6, 22);
        PD(p3, 7, 23);
    ...
    {
        // rows 8..11 in lanes 0..7, rows 24..27 in 8..15
        PD(p0, 8, 24);
        PD(p1, 9, 25);
        PD(p2, 10, 26);
        PD(p3, 11, 27);
    ...
    {
        // rows 12..15 in lanes 0..7, rows 28..31 in 8..15
        PD(p0, 12, 28);
        PD(p1, 13, 29);
        PD(p2, 14, 30);
        PD(p3, 15, 31);
