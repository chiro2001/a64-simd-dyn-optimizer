...
static int dynopt_satd_s16x8_r_vpaddl_a_subabs_impl(const uint8_t* pix1, intptr_t sp1,
                         const uint8_t* pix2, intptr_t sp2)
{
    ...
    uint32x4_t p0 = vpaddlq_u16(s0);
    uint32x4_t p1 = vpaddlq_u16(s1);
    return (int)vaddvq_u32(vaddq_u32(p0, p1));
}

extern "C" int dynopt_satd_s16x8_r_vpaddl_a_subabs(const uint8_t* pix1, intptr_t sp1,
                        const uint8_t* pix2, intptr_t sp2)
{
    return dynopt_satd_s16x8_r_vpaddl_a_subabs_impl(pix1, sp1, pix2, sp2);
}
