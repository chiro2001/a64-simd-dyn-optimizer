...
static int dynopt_satd_s8x16_r_vpaddl_a_subabs_impl(const uint8_t* pix1, intptr_t sp1,
...
extern "C" int dynopt_satd_s8x16_r_vpaddl_a_subabs(const uint8_t* pix1, intptr_t sp1,
                        const uint8_t* pix2, intptr_t sp2)
{
    return dynopt_satd_s8x16_r_vpaddl_a_subabs_impl(pix1, sp1, pix2, sp2);
}
