...
// SATD 8x8 pure NEON, reduce=vaddlv abs=subabs.
#include <arm_neon.h>
#include <stdint.h>
...
static int dynopt_satd_s16x16_r_vaddlv_a_subabs_impl(const uint8_t* pix1, intptr_t sp1,
...
extern "C" int dynopt_satd_s16x16_r_vaddlv_a_subabs(const uint8_t* pix1, intptr_t sp1,
                        const uint8_t* pix2, intptr_t sp2)
{
    return dynopt_satd_s16x16_r_vaddlv_a_subabs_impl(pix1, sp1, pix2, sp2);
}
