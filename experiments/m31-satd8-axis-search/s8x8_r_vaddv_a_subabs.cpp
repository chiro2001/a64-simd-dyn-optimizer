...
// SATD 8x8 pure NEON, reduce=vaddv abs=subabs.
#include <arm_neon.h>
#include <stdint.h>
...
extern "C" int dynopt_satd_s8x8_r_vaddv_a_subabs(const uint8_t* pix1, intptr_t sp1,
                        const uint8_t* pix2, intptr_t sp2)
{
    ...
    return (int)(vaddvq_u16(out[0]) + vaddvq_u16(out[1]));
}
