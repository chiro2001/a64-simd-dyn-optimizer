...
"$CXX" -O2 -DNDEBUG -march="$SVE_MARCH" -c "$GEN2" -o build/sve2.o
"$CXX" -O2 -DNDEBUG -march="$SVE_MARCH" -c "$GEN3" -o build/sve3.o
"$CXX" -O2 -DNDEBUG -march="$SVE_MARCH" -c "$GEN4" -o build/sve4.o
OBJDUMP="$OBJDUMP" python3 tools/count_asm_insns.py build/sve1.o > build/sve1-insns.txt
