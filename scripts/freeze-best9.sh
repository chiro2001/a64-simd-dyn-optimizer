#!/usr/bin/env bash
# Freeze-and-replicate best9 on a target 920B/950 (round-0022 P0).
#
...
#
# Usage:
#   scripts/freeze-best9.sh [user@host]
...
echo "[freeze] building best9 inject bundle"
...
cp build/dynopt-inject-best9-freeze/*.patch \
   build/dynopt-inject-best9-freeze/*.cpp \
   build/dynopt-inject-best9-freeze/*.o \
   build/dynopt-inject-best9-freeze/objects.txt "$PKG/out/"
cp build/preload-work-best9-freeze/*.o "$PKG/work/"
