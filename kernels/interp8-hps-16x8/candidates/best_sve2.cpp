    ...
    int16_t* dst, intptr_t dstride, int coeffIdx, int isRowExt)
{
    switch (coeffIdx)
    {
    case 1: hps_impl_1<1, 16, 8>(src, sstride, dst, dstride, isRowExt); break;
    case 2: hps_impl_2<2, 16, 8>(src, sstride, dst, dstride, isRowExt); break;
    default: hps_impl_3<3, 16, 8>(src, sstride, dst, dstride, isRowExt); break;
    }
}
