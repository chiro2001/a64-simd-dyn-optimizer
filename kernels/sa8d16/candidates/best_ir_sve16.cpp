...
extern "C" int dynopt_sa8d_16x16_sve16(const uint8_t* pix1, intptr_t sp1, const uint8_t* pix2, intptr_t sp2)
{
    if (svcntb() != 32) return 0;
    svint16_t v0001 = psv16_dual_load_diff8(pix1 + (0 + 0) * sp1 + 0, pix1 + (0 + 0) * sp1 + 8, pix2 + (0 + 0) * sp2 + 0, pix2 + (0 + 0) * sp2 + 8);
    svint16_t v0002 = psv16_dual_load_diff8(pix1 + (0 + 1) * sp1 + 0, pix1 + (0 + 1) * sp1 + 8, pix2 + (0 + 1) * sp2 + 0, pix2 + (0 + 1) * sp2 + 8);
    svint16_t v0003 = psv16_dual_load_diff8(pix1 + (0 + 2) * sp1 + 0, pix1 + (0 + 2) * sp1 + 8, pix2 + (0 + 2) * sp2 + 0, pix2 + (0 + 2) * sp2 + 8);
    svint16_t v0004 = psv16_dual_load_diff8(pix1 + (0 + 3) * sp1 + 0, pix1 + (0 + 3) * sp1 + 8, pix2 + (0 + 3) * sp2 + 0, pix2 + (0 + 3) * sp2 + 8);
    svint16_t v0005 = psv16_dual_load_diff8(pix1 + (0 + 4) * sp1 + 0, pix1 + (0 + 4) * sp1 + 8, pix2 + (0 + 4) * sp2 + 0, pix2 + (0 + 4) * sp2 + 8);
    svint16_t v0006 = psv16_dual_load_diff8(pix1 + (0 + 5) * sp1 + 0, pix1 + (0 + 5) * sp1 + 8, pix2 + (0 + 5) * sp2 + 0, pix2 + (0 + 5) * sp2 + 8);
    svint16_t v0007 = psv16_dual_load_diff8(pix1 + (0 + 6) * sp1 + 0, pix1 + (0 + 6) * sp1 + 8, pix2 + (0 + 6) * sp2 + 0, pix2 + (0 + 6) * sp2 + 8);
    svint16_t v0008 = psv16_dual_load_diff8(pix1 + (0 + 7) * sp1 + 0, pix1 + (0 + 7) * sp1 + 8, pix2 + (0 + 7) * sp2 + 0, pix2 + (0 + 7) * sp2 + 8);
    ...
    svint16_t v0025 = svadd_s16_x(pg16_s16(), v0013, v0021);
    svint16_t v0026 = svsub_s16_x(pg16_s16(), v0013, v0021);
    svint16_t v0027 = svadd_s16_x(pg16_s16(), v0015, v0023);
    svint16_t v0028 = svsub_s16_x(pg16_s16(), v0015, v0023);
    svint16_t v0029 = svadd_s16_x(pg16_s16(), v0014, v0022);
    svint16_t v0030 = svsub_s16_x(pg16_s16(), v0014, v0022);
    svint16_t v0031 = svadd_s16_x(pg16_s16(), v0016, v0024);
    svint16_t v0032 = svsub_s16_x(pg16_s16(), v0016, v0024);
    svint16_t v0033 = psv16_dual_trn1_s16(v0025, v0027);
    svint16_t v0034 = psv16_dual_trn2_s16(v0025, v0027);
    svint16_t v0035 = psv16_dual_trn1_s16(v0029, v0031);
    svint16_t v0036 = psv16_dual_trn2_s16(v0029, v0031);
    svint16_t v0037 = svadd_s16_x(pg16_s16(), v0033, v0034);
    svint16_t v0038 = svsub_s16_x(pg16_s16(), v0033, v0034);
    svint16_t v0039 = svadd_s16_x(pg16_s16(), v0035, v0036);
    svint16_t v0040 = svsub_s16_x(pg16_s16(), v0035, v0036);
    svint16_t v0041 = psv16_dual_trn1_s32(v0037, v0039);
    svint16_t v0042 = psv16_dual_trn2_s32(v0037, v0039);
    svint16_t v0043 = psv16_dual_trn1_s32(v0038, v0040);
    svint16_t v0044 = psv16_dual_trn2_s32(v0038, v0040);
    svint16_t v0045 = psv16_dual_trn1_s16(v0026, v0028);
    svint16_t v0046 = psv16_dual_trn2_s16(v0026, v0028);
    svint16_t v0047 = psv16_dual_trn1_s16(v0030, v0032);
    svint16_t v0048 = psv16_dual_trn2_s16(v0030, v0032);
    svint16_t v0049 = svadd_s16_x(pg16_s16(), v0045, v0046);
    svint16_t v0050 = svsub_s16_x(pg16_s16(), v0045, v0046);
    svint16_t v0051 = svadd_s16_x(pg16_s16(), v0047, v0048);
    svint16_t v0052 = svsub_s16_x(pg16_s16(), v0047, v0048);
    svint16_t v0053 = psv16_dual_trn1_s32(v0049, v0051);
    svint16_t v0054 = psv16_dual_trn2_s32(v0049, v0051);
    svint16_t v0055 = psv16_dual_trn1_s32(v0050, v0052);
    svint16_t v0056 = psv16_dual_trn2_s32(v0050, v0052);
    svint16_t v0057 = svadd_s16_x(pg16_s16(), v0041, v0042);
    svint16_t v0058 = svabs_s16_x(pg16_s16(), v0057);
    svint16_t v0059 = svabd_s16_x(pg16_s16(), v0041, v0042);
    svint16_t v0060 = svadd_s16_x(pg16_s16(), v0043, v0044);
    svint16_t v0061 = svabs_s16_x(pg16_s16(), v0060);
    svint16_t v0062 = svabd_s16_x(pg16_s16(), v0043, v0044);
    svint16_t v0063 = svadd_s16_x(pg16_s16(), v0053, v0054);
    svint16_t v0064 = svabs_s16_x(pg16_s16(), v0063);
    svint16_t v0065 = svabd_s16_x(pg16_s16(), v0053, v0054);
    svint16_t v0066 = svadd_s16_x(pg16_s16(), v0055, v0056);
    svint16_t v0067 = svabs_s16_x(pg16_s16(), v0066);
    svint16_t v0068 = svabd_s16_x(pg16_s16(), v0055, v0056);
    svint16_t v0069 = psv16_dual_trn1_s64(v0058, v0064);
    svint16_t v0070 = psv16_dual_trn2_s64(v0058, v0064);
    svint16_t v0071 = psv16_dual_trn1_s64(v0059, v0065);
    svint16_t v0072 = psv16_dual_trn2_s64(v0059, v0065);
    svint16_t v0073 = psv16_dual_trn1_s64(v0061, v0067);
    svint16_t v0074 = psv16_dual_trn2_s64(v0061, v0067);
    svint16_t v0075 = psv16_dual_trn1_s64(v0062, v0068);
    svint16_t v0076 = psv16_dual_trn2_s64(v0062, v0068);
    svuint16_t v0077 = svmax_u16_x(pg16_s16(), svreinterpret_u16_s16(v0069), svreinterpret_u16_s16(v0070));
    svuint16_t v0078 = svmax_u16_x(pg16_s16(), svreinterpret_u16_s16(v0071), svreinterpret_u16_s16(v0072));
    svuint16_t v0079 = svmax_u16_x(pg16_s16(), svreinterpret_u16_s16(v0073), svreinterpret_u16_s16(v0074));
    svuint16_t v0080 = svmax_u16_x(pg16_s16(), svreinterpret_u16_s16(v0075), svreinterpret_u16_s16(v0076));
    svuint16_t v0081 = svadd_u16_x(pg16_s16(), v0077, v0078);
    svuint16_t v0082 = svadd_u16_x(pg16_s16(), v0079, v0080);
    svint16_t v0083 = psv16_dual_load_diff8(pix1 + (0 + 0) * sp1 + 8, pix1 + (0 + 0) * sp1 + 0, pix2 + (0 + 0) * sp2 + 8, pix2 + (0 + 0) * sp2 + 0);
    svint16_t v0084 = psv16_dual_load_diff8(pix1 + (0 + 1) * sp1 + 8, pix1 + (0 + 1) * sp1 + 0, pix2 + (0 + 1) * sp2 + 8, pix2 + (0 + 1) * sp2 + 0);
    svint16_t v0085 = psv16_dual_load_diff8(pix1 + (0 + 2) * sp1 + 8, pix1 + (0 + 2) * sp1 + 0, pix2 + (0 + 2) * sp2 + 8, pix2 + (0 + 2) * sp2 + 0);
    svint16_t v0086 = psv16_dual_load_diff8(pix1 + (0 + 3) * sp1 + 8, pix1 + (0 + 3) * sp1 + 0, pix2 + (0 + 3) * sp2 + 8, pix2 + (0 + 3) * sp2 + 0);
    svint16_t v0087 = psv16_dual_load_diff8(pix1 + (0 + 4) * sp1 + 8, pix1 + (0 + 4) * sp1 + 0, pix2 + (0 + 4) * sp2 + 8, pix2 + (0 + 4) * sp2 + 0);
    svint16_t v0088 = psv16_dual_load_diff8(pix1 + (0 + 5) * sp1 + 8, pix1 + (0 + 5) * sp1 + 0, pix2 + (0 + 5) * sp2 + 8, pix2 + (0 + 5) * sp2 + 0);
    svint16_t v0089 = psv16_dual_load_diff8(pix1 + (0 + 6) * sp1 + 8, pix1 + (0 + 6) * sp1 + 0, pix2 + (0 + 6) * sp2 + 8, pix2 + (0 + 6) * sp2 + 0);
    svint16_t v0090 = psv16_dual_load_diff8(pix1 + (0 + 7) * sp1 + 8, pix1 + (0 + 7) * sp1 + 0, pix2 + (0 + 7) * sp2 + 8, pix2 + (0 + 7) * sp2 + 0);
    svint16_t v0091 = svadd_s16_x(pg16_s16(), v0083, v0084);
    svint16_t v0092 = svsub_s16_x(pg16_s16(), v0083, v0084);
    svint16_t v0093 = svadd_s16_x(pg16_s16(), v0085, v0086);
    svint16_t v0094 = svsub_s16_x(pg16_s16(), v0085, v0086);
    svint16_t v0095 = svadd_s16_x(pg16_s16(), v0091, v0093);
    svint16_t v0096 = svsub_s16_x(pg16_s16(), v0091, v0093);
    svint16_t v0097 = svadd_s16_x(pg16_s16(), v0092, v0094);
    svint16_t v0098 = svsub_s16_x(pg16_s16(), v0092, v0094);
    svint16_t v0099 = svadd_s16_x(pg16_s16(), v0087, v0088);
    svint16_t v0100 = svsub_s16_x(pg16_s16(), v0087, v0088);
    svint16_t v0101 = svadd_s16_x(pg16_s16(), v0089, v0090);
    svint16_t v0102 = svsub_s16_x(pg16_s16(), v0089, v0090);
    svint16_t v0103 = svadd_s16_x(pg16_s16(), v0099, v0101);
    svint16_t v0104 = svsub_s16_x(pg16_s16(), v0099, v0101);
    svint16_t v0105 = svadd_s16_x(pg16_s16(), v0100, v0102);
    svint16_t v0106 = svsub_s16_x(pg16_s16(), v0100, v0102);
    svint16_t v0107 = svadd_s16_x(pg16_s16(), v0095, v0103);
    svint16_t v0108 = svsub_s16_x(pg16_s16(), v0095, v0103);
    svint16_t v0109 = svadd_s16_x(pg16_s16(), v0097, v0105);
    svint16_t v0110 = svsub_s16_x(pg16_s16(), v0097, v0105);
    svint16_t v0111 = svadd_s16_x(pg16_s16(), v0096, v0104);
    svint16_t v0112 = svsub_s16_x(pg16_s16(), v0096, v0104);
    svint16_t v0113 = svadd_s16_x(pg16_s16(), v0098, v0106);
    svint16_t v0114 = svsub_s16_x(pg16_s16(), v0098, v0106);
    svint16_t v0115 = psv16_dual_trn1_s16(v0107, v0109);
    svint16_t v0116 = psv16_dual_trn2_s16(v0107, v0109);
    svint16_t v0117 = psv16_dual_trn1_s16(v0111, v0113);
    svint16_t v0118 = psv16_dual_trn2_s16(v0111, v0113);
    svint16_t v0119 = svadd_s16_x(pg16_s16(), v0115, v0116);
    svint16_t v0120 = svsub_s16_x(pg16_s16(), v0115, v0116);
    svint16_t v0121 = svadd_s16_x(pg16_s16(), v0117, v0118);
    svint16_t v0122 = svsub_s16_x(pg16_s16(), v0117, v0118);
    svint16_t v0123 = psv16_dual_trn1_s32(v0119, v0121);
    svint16_t v0124 = psv16_dual_trn2_s32(v0119, v0121);
    svint16_t v0125 = psv16_dual_trn1_s32(v0120, v0122);
    svint16_t v0126 = psv16_dual_trn2_s32(v0120, v0122);
    svint16_t v0127 = psv16_dual_trn1_s16(v0108, v0110);
    svint16_t v0128 = psv16_dual_trn2_s16(v0108, v0110);
    svint16_t v0129 = psv16_dual_trn1_s16(v0112, v0114);
    svint16_t v0130 = psv16_dual_trn2_s16(v0112, v0114);
    svint16_t v0131 = svadd_s16_x(pg16_s16(), v0127, v0128);
    svint16_t v0132 = svsub_s16_x(pg16_s16(), v0127, v0128);
    svint16_t v0133 = svadd_s16_x(pg16_s16(), v0129, v0130);
    svint16_t v0134 = svsub_s16_x(pg16_s16(), v0129, v0130);
    svint16_t v0135 = psv16_dual_trn1_s32(v0131, v0133);
    svint16_t v0136 = psv16_dual_trn2_s32(v0131, v0133);
    svint16_t v0137 = psv16_dual_trn1_s32(v0132, v0134);
    svint16_t v0138 = psv16_dual_trn2_s32(v0132, v0134);
    svint16_t v0139 = svadd_s16_x(pg16_s16(), v0123, v0124);
    svint16_t v0140 = svabs_s16_x(pg16_s16(), v0139);
    svint16_t v0141 = svabd_s16_x(pg16_s16(), v0123, v0124);
    svint16_t v0142 = svadd_s16_x(pg16_s16(), v0125, v0126);
    svint16_t v0143 = svabs_s16_x(pg16_s16(), v0142);
    svint16_t v0144 = svabd_s16_x(pg16_s16(), v0125, v0126);
    svint16_t v0145 = svadd_s16_x(pg16_s16(), v0135, v0136);
    svint16_t v0146 = svabs_s16_x(pg16_s16(), v0145);
    svint16_t v0147 = svabd_s16_x(pg16_s16(), v0135, v0136);
    svint16_t v0148 = svadd_s16_x(pg16_s16(), v0137, v0138);
    svint16_t v0149 = svabs_s16_x(pg16_s16(), v0148);
    svint16_t v0150 = svabd_s16_x(pg16_s16(), v0137, v0138);
    svint16_t v0151 = psv16_dual_trn1_s64(v0140, v0146);
    svint16_t v0152 = psv16_dual_trn2_s64(v0140, v0146);
    svint16_t v0153 = psv16_dual_trn1_s64(v0141, v0147);
    svint16_t v0154 = psv16_dual_trn2_s64(v0141, v0147);
    svint16_t v0155 = psv16_dual_trn1_s64(v0143, v0149);
    svint16_t v0156 = psv16_dual_trn2_s64(v0143, v0149);
    svint16_t v0157 = psv16_dual_trn1_s64(v0144, v0150);
    svint16_t v0158 = psv16_dual_trn2_s64(v0144, v0150);
    svuint16_t v0159 = svmax_u16_x(pg16_s16(), svreinterpret_u16_s16(v0151), svreinterpret_u16_s16(v0152));
    svuint16_t v0160 = svmax_u16_x(pg16_s16(), svreinterpret_u16_s16(v0153), svreinterpret_u16_s16(v0154));
    svuint16_t v0161 = svmax_u16_x(pg16_s16(), svreinterpret_u16_s16(v0155), svreinterpret_u16_s16(v0156));
    svuint16_t v0162 = svmax_u16_x(pg16_s16(), svreinterpret_u16_s16(v0157), svreinterpret_u16_s16(v0158));
    svuint16_t v0163 = svadd_u16_x(pg16_s16(), v0159, v0160);
    svuint16_t v0164 = svadd_u16_x(pg16_s16(), v0161, v0162);
    svuint16_t v0165 = svadd_u16_x(pg16_s16(), v0081, v0163);
    svuint16_t v0166 = svadd_u16_x(pg16_s16(), v0082, v0164);
    svint16_t v0167 = psv16_dual_load_diff8(pix1 + (8 + 0) * sp1 + 0, pix1 + (8 + 0) * sp1 + 8, pix2 + (8 + 0) * sp2 + 0, pix2 + (8 + 0) * sp2 + 8);
    svint16_t v0168 = psv16_dual_load_diff8(pix1 + (8 + 1) * sp1 + 0, pix1 + (8 + 1) * sp1 + 8, pix2 + (8 + 1) * sp2 + 0, pix2 + (8 + 1) * sp2 + 8);
    svint16_t v0169 = psv16_dual_load_diff8(pix1 + (8 + 2) * sp1 + 0, pix1 + (8 + 2) * sp1 + 8, pix2 + (8 + 2) * sp2 + 0, pix2 + (8 + 2) * sp2 + 8);
    svint16_t v0170 = psv16_dual_load_diff8(pix1 + (8 + 3) * sp1 + 0, pix1 + (8 + 3) * sp1 + 8, pix2 + (8 + 3) * sp2 + 0, pix2 + (8 + 3) * sp2 + 8);
    svint16_t v0171 = psv16_dual_load_diff8(pix1 + (8 + 4) * sp1 + 0, pix1 + (8 + 4) * sp1 + 8, pix2 + (8 + 4) * sp2 + 0, pix2 + (8 + 4) * sp2 + 8);
    svint16_t v0172 = psv16_dual_load_diff8(pix1 + (8 + 5) * sp1 + 0, pix1 + (8 + 5) * sp1 + 8, pix2 + (8 + 5) * sp2 + 0, pix2 + (8 + 5) * sp2 + 8);
    svint16_t v0173 = psv16_dual_load_diff8(pix1 + (8 + 6) * sp1 + 0, pix1 + (8 + 6) * sp1 + 8, pix2 + (8 + 6) * sp2 + 0, pix2 + (8 + 6) * sp2 + 8);
    svint16_t v0174 = psv16_dual_load_diff8(pix1 + (8 + 7) * sp1 + 0, pix1 + (8 + 7) * sp1 + 8, pix2 + (8 + 7) * sp2 + 0, pix2 + (8 + 7) * sp2 + 8);
    svint16_t v0175 = svadd_s16_x(pg16_s16(), v0167, v0168);
    svint16_t v0176 = svsub_s16_x(pg16_s16(), v0167, v0168);
    svint16_t v0177 = svadd_s16_x(pg16_s16(), v0169, v0170);
    svint16_t v0178 = svsub_s16_x(pg16_s16(), v0169, v0170);
    svint16_t v0179 = svadd_s16_x(pg16_s16(), v0175, v0177);
    svint16_t v0180 = svsub_s16_x(pg16_s16(), v0175, v0177);
    svint16_t v0181 = svadd_s16_x(pg16_s16(), v0176, v0178);
    svint16_t v0182 = svsub_s16_x(pg16_s16(), v0176, v0178);
    svint16_t v0183 = svadd_s16_x(pg16_s16(), v0171, v0172);
    svint16_t v0184 = svsub_s16_x(pg16_s16(), v0171, v0172);
    svint16_t v0185 = svadd_s16_x(pg16_s16(), v0173, v0174);
    svint16_t v0186 = svsub_s16_x(pg16_s16(), v0173, v0174);
    svint16_t v0187 = svadd_s16_x(pg16_s16(), v0183, v0185);
    svint16_t v0188 = svsub_s16_x(pg16_s16(), v0183, v0185);
    svint16_t v0189 = svadd_s16_x(pg16_s16(), v0184, v0186);
    svint16_t v0190 = svsub_s16_x(pg16_s16(), v0184, v0186);
    svint16_t v0191 = svadd_s16_x(pg16_s16(), v0179, v0187);
    svint16_t v0192 = svsub_s16_x(pg16_s16(), v0179, v0187);
    svint16_t v0193 = svadd_s16_x(pg16_s16(), v0181, v0189);
    svint16_t v0194 = svsub_s16_x(pg16_s16(), v0181, v0189);
    svint16_t v0195 = svadd_s16_x(pg16_s16(), v0180, v0188);
    svint16_t v0196 = svsub_s16_x(pg16_s16(), v0180, v0188);
    svint16_t v0197 = svadd_s16_x(pg16_s16(), v0182, v0190);
    svint16_t v0198 = svsub_s16_x(pg16_s16(), v0182, v0190);
    svint16_t v0199 = psv16_dual_trn1_s16(v0191, v0193);
    svint16_t v0200 = psv16_dual_trn2_s16(v0191, v0193);
    svint16_t v0201 = psv16_dual_trn1_s16(v0195, v0197);
    svint16_t v0202 = psv16_dual_trn2_s16(v0195, v0197);
    svint16_t v0203 = svadd_s16_x(pg16_s16(), v0199, v0200);
    svint16_t v0204 = svsub_s16_x(pg16_s16(), v0199, v0200);
    svint16_t v0205 = svadd_s16_x(pg16_s16(), v0201, v0202);
    svint16_t v0206 = svsub_s16_x(pg16_s16(), v0201, v0202);
    svint16_t v0207 = psv16_dual_trn1_s32(v0203, v0205);
    svint16_t v0208 = psv16_dual_trn2_s32(v0203, v0205);
    svint16_t v0209 = psv16_dual_trn1_s32(v0204, v0206);
    svint16_t v0210 = psv16_dual_trn2_s32(v0204, v0206);
    svint16_t v0211 = psv16_dual_trn1_s16(v0192, v0194);
    svint16_t v0212 = psv16_dual_trn2_s16(v0192, v0194);
    svint16_t v0213 = psv16_dual_trn1_s16(v0196, v0198);
    svint16_t v0214 = psv16_dual_trn2_s16(v0196, v0198);
    svint16_t v0215 = svadd_s16_x(pg16_s16(), v0211, v0212);
    svint16_t v0216 = svsub_s16_x(pg16_s16(), v0211, v0212);
    svint16_t v0217 = svadd_s16_x(pg16_s16(), v0213, v0214);
    svint16_t v0218 = svsub_s16_x(pg16_s16(), v0213, v0214);
    svint16_t v0219 = psv16_dual_trn1_s32(v0215, v0217);
    svint16_t v0220 = psv16_dual_trn2_s32(v0215, v0217);
    svint16_t v0221 = psv16_dual_trn1_s32(v0216, v0218);
    svint16_t v0222 = psv16_dual_trn2_s32(v0216, v0218);
    svint16_t v0223 = svadd_s16_x(pg16_s16(), v0207, v0208);
    svint16_t v0224 = svabs_s16_x(pg16_s16(), v0223);
    svint16_t v0225 = svabd_s16_x(pg16_s16(), v0207, v0208);
    svint16_t v0226 = svadd_s16_x(pg16_s16(), v0209, v0210);
    svint16_t v0227 = svabs_s16_x(pg16_s16(), v0226);
    svint16_t v0228 = svabd_s16_x(pg16_s16(), v0209, v0210);
    svint16_t v0229 = svadd_s16_x(pg16_s16(), v0219, v0220);
    svint16_t v0230 = svabs_s16_x(pg16_s16(), v0229);
    svint16_t v0231 = svabd_s16_x(pg16_s16(), v0219, v0220);
    svint16_t v0232 = svadd_s16_x(pg16_s16(), v0221, v0222);
    svint16_t v0233 = svabs_s16_x(pg16_s16(), v0232);
    svint16_t v0234 = svabd_s16_x(pg16_s16(), v0221, v0222);
    svint16_t v0235 = psv16_dual_trn1_s64(v0224, v0230);
    svint16_t v0236 = psv16_dual_trn2_s64(v0224, v0230);
    svint16_t v0237 = psv16_dual_trn1_s64(v0225, v0231);
    svint16_t v0238 = psv16_dual_trn2_s64(v0225, v0231);
    svint16_t v0239 = psv16_dual_trn1_s64(v0227, v0233);
    svint16_t v0240 = psv16_dual_trn2_s64(v0227, v0233);
    svint16_t v0241 = psv16_dual_trn1_s64(v0228, v0234);
    svint16_t v0242 = psv16_dual_trn2_s64(v0228, v0234);
    svuint16_t v0243 = svmax_u16_x(pg16_s16(), svreinterpret_u16_s16(v0235), svreinterpret_u16_s16(v0236));
    svuint16_t v0244 = svmax_u16_x(pg16_s16(), svreinterpret_u16_s16(v0237), svreinterpret_u16_s16(v0238));
    svuint16_t v0245 = svmax_u16_x(pg16_s16(), svreinterpret_u16_s16(v0239), svreinterpret_u16_s16(v0240));
    svuint16_t v0246 = svmax_u16_x(pg16_s16(), svreinterpret_u16_s16(v0241), svreinterpret_u16_s16(v0242));
    svuint16_t v0247 = svadd_u16_x(pg16_s16(), v0243, v0244);
    svuint16_t v0248 = svadd_u16_x(pg16_s16(), v0245, v0246);
    svuint16_t v0249 = svadd_u16_x(pg16_s16(), v0165, v0247);
    svuint16_t v0250 = svadd_u16_x(pg16_s16(), v0166, v0248);
    svint16_t v0251 = psv16_dual_load_diff8(pix1 + (8 + 0) * sp1 + 8, pix1 + (8 + 0) * sp1 + 0, pix2 + (8 + 0) * sp2 + 8, pix2 + (8 + 0) * sp2 + 0);
    svint16_t v0252 = psv16_dual_load_diff8(pix1 + (8 + 1) * sp1 + 8, pix1 + (8 + 1) * sp1 + 0, pix2 + (8 + 1) * sp2 + 8, pix2 + (8 + 1) * sp2 + 0);
    svint16_t v0253 = psv16_dual_load_diff8(pix1 + (8 + 2) * sp1 + 8, pix1 + (8 + 2) * sp1 + 0, pix2 + (8 + 2) * sp2 + 8, pix2 + (8 + 2) * sp2 + 0);
    svint16_t v0254 = psv16_dual_load_diff8(pix1 + (8 + 3) * sp1 + 8, pix1 + (8 + 3) * sp1 + 0, pix2 + (8 + 3) * sp2 + 8, pix2 + (8 + 3) * sp2 + 0);
    svint16_t v0255 = psv16_dual_load_diff8(pix1 + (8 + 4) * sp1 + 8, pix1 + (8 + 4) * sp1 + 0, pix2 + (8 + 4) * sp2 + 8, pix2 + (8 + 4) * sp2 + 0);
    svint16_t v0256 = psv16_dual_load_diff8(pix1 + (8 + 5) * sp1 + 8, pix1 + (8 + 5) * sp1 + 0, pix2 + (8 + 5) * sp2 + 8, pix2 + (8 + 5) * sp2 + 0);
    svint16_t v0257 = psv16_dual_load_diff8(pix1 + (8 + 6) * sp1 + 8, pix1 + (8 + 6) * sp1 + 0, pix2 + (8 + 6) * sp2 + 8, pix2 + (8 + 6) * sp2 + 0);
    svint16_t v0258 = psv16_dual_load_diff8(pix1 + (8 + 7) * sp1 + 8, pix1 + (8 + 7) * sp1 + 0, pix2 + (8 + 7) * sp2 + 8, pix2 + (8 + 7) * sp2 + 0);
    svint16_t v0259 = svadd_s16_x(pg16_s16(), v0251, v0252);
    svint16_t v0260 = svsub_s16_x(pg16_s16(), v0251, v0252);
    svint16_t v0261 = svadd_s16_x(pg16_s16(), v0253, v0254);
    svint16_t v0262 = svsub_s16_x(pg16_s16(), v0253, v0254);
    svint16_t v0263 = svadd_s16_x(pg16_s16(), v0259, v0261);
    svint16_t v0264 = svsub_s16_x(pg16_s16(), v0259, v0261);
    svint16_t v0265 = svadd_s16_x(pg16_s16(), v0260, v0262);
    svint16_t v0266 = svsub_s16_x(pg16_s16(), v0260, v0262);
    svint16_t v0267 = svadd_s16_x(pg16_s16(), v0255, v0256);
    svint16_t v0268 = svsub_s16_x(pg16_s16(), v0255, v0256);
    svint16_t v0269 = svadd_s16_x(pg16_s16(), v0257, v0258);
    svint16_t v0270 = svsub_s16_x(pg16_s16(), v0257, v0258);
    svint16_t v0271 = svadd_s16_x(pg16_s16(), v0267, v0269);
    svint16_t v0272 = svsub_s16_x(pg16_s16(), v0267, v0269);
    svint16_t v0273 = svadd_s16_x(pg16_s16(), v0268, v0270);
    svint16_t v0274 = svsub_s16_x(pg16_s16(), v0268, v0270);
    svint16_t v0275 = svadd_s16_x(pg16_s16(), v0263, v0271);
    svint16_t v0276 = svsub_s16_x(pg16_s16(), v0263, v0271);
    svint16_t v0277 = svadd_s16_x(pg16_s16(), v0265, v0273);
    svint16_t v0278 = svsub_s16_x(pg16_s16(), v0265, v0273);
    svint16_t v0279 = svadd_s16_x(pg16_s16(), v0264, v0272);
    svint16_t v0280 = svsub_s16_x(pg16_s16(), v0264, v0272);
    svint16_t v0281 = svadd_s16_x(pg16_s16(), v0266, v0274);
    svint16_t v0282 = svsub_s16_x(pg16_s16(), v0266, v0274);
    svint16_t v0283 = psv16_dual_trn1_s16(v0275, v0277);
    svint16_t v0284 = psv16_dual_trn2_s16(v0275, v0277);
    svint16_t v0285 = psv16_dual_trn1_s16(v0279, v0281);
    svint16_t v0286 = psv16_dual_trn2_s16(v0279, v0281);
    svint16_t v0287 = svadd_s16_x(pg16_s16(), v0283, v0284);
    svint16_t v0288 = svsub_s16_x(pg16_s16(), v0283, v0284);
    svint16_t v0289 = svadd_s16_x(pg16_s16(), v0285, v0286);
    svint16_t v0290 = svsub_s16_x(pg16_s16(), v0285, v0286);
    svint16_t v0291 = psv16_dual_trn1_s32(v0287, v0289);
    svint16_t v0292 = psv16_dual_trn2_s32(v0287, v0289);
    svint16_t v0293 = psv16_dual_trn1_s32(v0288, v0290);
    svint16_t v0294 = psv16_dual_trn2_s32(v0288, v0290);
    svint16_t v0295 = psv16_dual_trn1_s16(v0276, v0278);
    svint16_t v0296 = psv16_dual_trn2_s16(v0276, v0278);
    svint16_t v0297 = psv16_dual_trn1_s16(v0280, v0282);
    svint16_t v0298 = psv16_dual_trn2_s16(v0280, v0282);
    svint16_t v0299 = svadd_s16_x(pg16_s16(), v0295, v0296);
    svint16_t v0300 = svsub_s16_x(pg16_s16(), v0295, v0296);
    svint16_t v0301 = svadd_s16_x(pg16_s16(), v0297, v0298);
    svint16_t v0302 = svsub_s16_x(pg16_s16(), v0297, v0298);
    svint16_t v0303 = psv16_dual_trn1_s32(v0299, v0301);
    svint16_t v0304 = psv16_dual_trn2_s32(v0299, v0301);
    svint16_t v0305 = psv16_dual_trn1_s32(v0300, v0302);
    svint16_t v0306 = psv16_dual_trn2_s32(v0300, v0302);
    svint16_t v0307 = svadd_s16_x(pg16_s16(), v0291, v0292);
    svint16_t v0308 = svabs_s16_x(pg16_s16(), v0307);
    svint16_t v0309 = svabd_s16_x(pg16_s16(), v0291, v0292);
    svint16_t v0310 = svadd_s16_x(pg16_s16(), v0293, v0294);
    svint16_t v0311 = svabs_s16_x(pg16_s16(), v0310);
    svint16_t v0312 = svabd_s16_x(pg16_s16(), v0293, v0294);
    svint16_t v0313 = svadd_s16_x(pg16_s16(), v0303, v0304);
    svint16_t v0314 = svabs_s16_x(pg16_s16(), v0313);
    svint16_t v0315 = svabd_s16_x(pg16_s16(), v0303, v0304);
    svint16_t v0316 = svadd_s16_x(pg16_s16(), v0305, v0306);
    svint16_t v0317 = svabs_s16_x(pg16_s16(), v0316);
    svint16_t v0318 = svabd_s16_x(pg16_s16(), v0305, v0306);
    svint16_t v0319 = psv16_dual_trn1_s64(v0308, v0314);
    svint16_t v0320 = psv16_dual_trn2_s64(v0308, v0314);
    svint16_t v0321 = psv16_dual_trn1_s64(v0309, v0315);
    svint16_t v0322 = psv16_dual_trn2_s64(v0309, v0315);
    svint16_t v0323 = psv16_dual_trn1_s64(v0311, v0317);
    svint16_t v0324 = psv16_dual_trn2_s64(v0311, v0317);
    svint16_t v0325 = psv16_dual_trn1_s64(v0312, v0318);
    svint16_t v0326 = psv16_dual_trn2_s64(v0312, v0318);
    svuint16_t v0327 = svmax_u16_x(pg16_s16(), svreinterpret_u16_s16(v0319), svreinterpret_u16_s16(v0320));
    svuint16_t v0328 = svmax_u16_x(pg16_s16(), svreinterpret_u16_s16(v0321), svreinterpret_u16_s16(v0322));
    svuint16_t v0329 = svmax_u16_x(pg16_s16(), svreinterpret_u16_s16(v0323), svreinterpret_u16_s16(v0324));
    svuint16_t v0330 = svmax_u16_x(pg16_s16(), svreinterpret_u16_s16(v0325), svreinterpret_u16_s16(v0326));
    svuint16_t v0331 = svadd_u16_x(pg16_s16(), v0327, v0328);
    svuint16_t v0332 = svadd_u16_x(pg16_s16(), v0329, v0330);
    svuint16_t v0333 = svadd_u16_x(pg16_s16(), v0249, v0331);
    svuint16_t v0334 = svadd_u16_x(pg16_s16(), v0250, v0332);
    svuint16_t v0335 = svadd_u16_x(pg16_s16(), v0333, v0334);
    int32_t v0336 = ((psv16_reduce_u16_u32(v0335) + 2) >> 2);
    return v0336;
}
