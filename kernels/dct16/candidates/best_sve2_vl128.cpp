...
static inline void pass1Butterfly16_sve(const int16_t *src, int16_t *dst, intptr_t srcStride)
{
    ...
    for (int i = 0; i < line; i += 4)
    {
        for (int k = 1; k < 16; k += 2)
        {
            ...
            int64x2_t t0 = sdotq_s16(vdupq_n_s64(0), c0_c4, O[i + 0]);
            int64x2_t t1 = sdotq_s16(vdupq_n_s64(0), c0_c4, O[i + 1]);
            int64x2_t t2 = sdotq_s16(vdupq_n_s64(0), c0_c4, O[i + 2]);
            int64x2_t t3 = sdotq_s16(vdupq_n_s64(0), c0_c4, O[i + 3]);
        ...
        for (int k = 2; k < 16; k += 4)
        {
            ...
            int64x2_t t0 = sdotq_s16(vdupq_n_s64(0), c0, EO[i / 2 + 0]);
            int64x2_t t1 = sdotq_s16(vdupq_n_s64(0), c0, EO[i / 2 + 1]);
