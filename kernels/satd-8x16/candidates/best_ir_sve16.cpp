...
extern "C" int dynopt_satd_8x16_sve16(const uint8_t* pix1, intptr_t sp1, const uint8_t* pix2, intptr_t sp2)
{
    ...
    svint16_t v0059 = psv16_dual_load_diff8_split(pix1 + 8 * sp1, pix2 + 8 * sp2, 1);
    svint16_t v0060 = psv16_dual_load_diff8_split(pix1 + 9 * sp1, pix2 + 9 * sp2, 1);
    svint16_t v0061 = psv16_dual_load_diff8_split(pix1 + 10 * sp1, pix2 + 10 * sp2, 1);
    svint16_t v0062 = psv16_dual_load_diff8_split(pix1 + 11 * sp1, pix2 + 11 * sp2, 1);
    svint16_t v0063 = psv16_dual_load_diff8_split(pix1 + 12 * sp1, pix2 + 12 * sp2, 1);
    svint16_t v0064 = psv16_dual_load_diff8_split(pix1 + 13 * sp1, pix2 + 13 * sp2, 1);
    svint16_t v0065 = psv16_dual_load_diff8_split(pix1 + 14 * sp1, pix2 + 14 * sp2, 1);
    svint16_t v0066 = psv16_dual_load_diff8_split(pix1 + 15 * sp1, pix2 + 15 * sp2, 1);
