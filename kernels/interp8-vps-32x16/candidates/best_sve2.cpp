...
extern "C" void dynopt_interp8_vps_32x16_sve2(
    const uint8_t* src, intptr_t sstride,
    int16_t* dst, intptr_t dstride, int coeffIdx)
{
    switch (coeffIdx)
    {
    case 1: vps_impl_1<1, 32, 16>(src, sstride, dst, dstride); break;
    case 2: vps_impl_2<2, 32, 16>(src, sstride, dst, dstride); break;
    default: vps_impl_3<3, 32, 16>(src, sstride, dst, dstride); break;
    }
}
