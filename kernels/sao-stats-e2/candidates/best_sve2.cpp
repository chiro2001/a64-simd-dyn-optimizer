...
extern "C" void dynopt_sao_stats_e2_64_sve2(const int16_t* diff, const uint8_t* rec, intptr_t stride, int8_t* upBuff1, int8_t* upBufft, int32_t* stats, int32_t* count)
{
    ...
    upBufft[0] = d0 < 0 ? -1 : (d0 > 0 ? 1 : 0);
    {
        ...
        int8x16_t sd = sign16n(rec + 0, rec + 0 + stride + 1);
        int8x16_t et = vsubq_s8(sd, su);
        vst1q_s8(upBufft + 0 + 1, sd);
 ...
 vdupq_n_s8(2)));
    ...
    }
    {
        ...
        int8x16_t sd = sign16n(rec + 16, rec + 16 + stride + 1);
        int8x16_t et = vsubq_s8(sd, su);
        vst1q_s8(upBufft + 16 + 1, sd);
        svint8_t svet = svset_neonq_s8(svundef_s8(), et);
        count_u8 = vaddq_u8(count_u8,
            svget_neonq_u8(svhistseg_s8(svidx, svet)));
        int8x16_t m0 = vreinterpretq_s8_u8(vceqq_s8(et,
 ...
 vdupq_n_s8(2)));
    ...
    }
    {
        ...
        int8x16_t sd = sign16n(rec + 32, rec + 32 + stride + 1);
        int8x16_t et = vsubq_s8(sd, su);
        vst1q_s8(upBufft + 32 + 1, sd);
        svint8_t svet = svset_neonq_s8(svundef_s8(), et);
        count_u8 = vaddq_u8(count_u8,
            svget_neonq_u8(svhistseg_s8(svidx, svet)));
        int8x16_t m0 = vreinterpretq_s8_u8(vceqq_s8(et,
 ...
 vdupq_n_s8(2)));
    ...
    }
    {
        ...
        int8x16_t sd = sign16n(rec + 48, rec + 48 + stride + 1);
        int8x16_t et = vsubq_s8(sd, su);
        vst1q_s8(upBufft + 48 + 1, sd);
        svint8_t svet = svset_neonq_s8(svundef_s8(), et);
        count_u8 = vaddq_u8(count_u8,
            svget_neonq_u8(svhistseg_s8(svidx, svet)));
        int8x16_t m0 = vreinterpretq_s8_u8(vceqq_s8(et,
