...
extern "C" void dynopt_avg_pp_16x16_sve16(uint8_t* dst, intptr_t dstStride, const uint8_t* pix1, intptr_t stride1, const uint8_t* pix2, intptr_t stride2)
{
    if (svcntb() != 32) return;
    svuint8_t v0001 = psv16_ld1b_pair(pix1 + 0 * stride1, pix1 + 1 * stride1);
    svuint8_t v0002 = psv16_ld1b_pair(pix2 + 0 * stride2, pix2 + 1 * stride2);
    svuint8_t v0003 = svrhadd_u8_x(svptrue_b8(), v0001, v0002);
    psv16_st1b_pair(dst + 0 * dstStride, dst + 1 * dstStride, v0003);
    svuint8_t v0007 = svrhadd_u8_x(svptrue_b8(), v0001, v0002);
    svuint8_t v0009 = psv16_ld1b_pair(pix1 + 2 * stride1, pix1 + 3 * stride1);
    svuint8_t v0010 = psv16_ld1b_pair(pix2 + 2 * stride2, pix2 + 3 * stride2);
    svuint8_t v0011 = svrhadd_u8_x(svptrue_b8(), v0009, v0010);
    psv16_st1b_pair(dst + 2 * dstStride, dst + 3 * dstStride, v0011);
    svuint8_t v0015 = svrhadd_u8_x(svptrue_b8(), v0009, v0010);
    svuint8_t v0017 = psv16_ld1b_pair(pix1 + 4 * stride1, pix1 + 5 * stride1);
    svuint8_t v0018 = psv16_ld1b_pair(pix2 + 4 * stride2, pix2 + 5 * stride2);
    svuint8_t v0019 = svrhadd_u8_x(svptrue_b8(), v0017, v0018);
    psv16_st1b_pair(dst + 4 * dstStride, dst + 5 * dstStride, v0019);
    svuint8_t v0023 = svrhadd_u8_x(svptrue_b8(), v0017, v0018);
    svuint8_t v0025 = psv16_ld1b_pair(pix1 + 6 * stride1, pix1 + 7 * stride1);
    svuint8_t v0026 = psv16_ld1b_pair(pix2 + 6 * stride2, pix2 + 7 * stride2);
    svuint8_t v0027 = svrhadd_u8_x(svptrue_b8(), v0025, v0026);
    psv16_st1b_pair(dst + 6 * dstStride, dst + 7 * dstStride, v0027);
    svuint8_t v0031 = svrhadd_u8_x(svptrue_b8(), v0025, v0026);
    svuint8_t v0033 = psv16_ld1b_pair(pix1 + 8 * stride1, pix1 + 9 * stride1);
    svuint8_t v0034 = psv16_ld1b_pair(pix2 + 8 * stride2, pix2 + 9 * stride2);
    svuint8_t v0035 = svrhadd_u8_x(svptrue_b8(), v0033, v0034);
    psv16_st1b_pair(dst + 8 * dstStride, dst + 9 * dstStride, v0035);
    svuint8_t v0039 = svrhadd_u8_x(svptrue_b8(), v0033, v0034);
    svuint8_t v0041 = psv16_ld1b_pair(pix1 + 10 * stride1, pix1 + 11 * stride1);
    svuint8_t v0042 = psv16_ld1b_pair(pix2 + 10 * stride2, pix2 + 11 * stride2);
    svuint8_t v0043 = svrhadd_u8_x(svptrue_b8(), v0041, v0042);
    psv16_st1b_pair(dst + 10 * dstStride, dst + 11 * dstStride, v0043);
    svuint8_t v0047 = svrhadd_u8_x(svptrue_b8(), v0041, v0042);
    svuint8_t v0049 = psv16_ld1b_pair(pix1 + 12 * stride1, pix1 + 13 * stride1);
    svuint8_t v0050 = psv16_ld1b_pair(pix2 + 12 * stride2, pix2 + 13 * stride2);
    svuint8_t v0051 = svrhadd_u8_x(svptrue_b8(), v0049, v0050);
    psv16_st1b_pair(dst + 12 * dstStride, dst + 13 * dstStride, v0051);
    svuint8_t v0055 = svrhadd_u8_x(svptrue_b8(), v0049, v0050);
    svuint8_t v0057 = psv16_ld1b_pair(pix1 + 14 * stride1, pix1 + 15 * stride1);
    svuint8_t v0058 = psv16_ld1b_pair(pix2 + 14 * stride2, pix2 + 15 * stride2);
    svuint8_t v0059 = svrhadd_u8_x(svptrue_b8(), v0057, v0058);
    psv16_st1b_pair(dst + 14 * dstStride, dst + 15 * dstStride, v0059);
    svuint8_t v0063 = svrhadd_u8_x(svptrue_b8(), v0057, v0058);
}
