...
extern "C" int dynopt_satd_16x8_sve16(const uint8_t* pix1, intptr_t sp1, const uint8_t* pix2, intptr_t sp2)
{
    ...
    svint16_t v0005 = psv16_dual_load_diff8_split(pix1 + 4 * sp1, pix2 + 4 * sp2, 0);
    svint16_t v0006 = psv16_dual_load_diff8_split(pix1 + 5 * sp1, pix2 + 5 * sp2, 0);
    svint16_t v0007 = psv16_dual_load_diff8_split(pix1 + 6 * sp1, pix2 + 6 * sp2, 0);
    svint16_t v0008 = psv16_dual_load_diff8_split(pix1 + 7 * sp1, pix2 + 7 * sp2, 0);
    ...
    svint16_t v0059 = psv16_dual_load_diff8_split(pix1 + 0 * sp1 + 8, pix2 + 0 * sp2 + 8, 1);
    svint16_t v0060 = psv16_dual_load_diff8_split(pix1 + 1 * sp1 + 8, pix2 + 1 * sp2 + 8, 1);
    svint16_t v0061 = psv16_dual_load_diff8_split(pix1 + 2 * sp1 + 8, pix2 + 2 * sp2 + 8, 1);
    svint16_t v0062 = psv16_dual_load_diff8_split(pix1 + 3 * sp1 + 8, pix2 + 3 * sp2 + 8, 1);
    ...
    svuint16_t v0117 = svadd_u16_x(pg16_s16(), v0057, v0058);
    svuint16_t v0118 = svadd_u16_x(pg16_s16(), v0117, v0115);
    svuint16_t v0119 = svadd_u16_x(pg16_s16(), v0118, v0116);
    int32_t v0120 = psv16_reduce_u16_u32(v0119);
    return v0120;
}
