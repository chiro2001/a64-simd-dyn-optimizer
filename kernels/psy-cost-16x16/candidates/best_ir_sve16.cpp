...
extern "C" uint64_t dynopt_pixel_var_16x16_sve16(const uint8_t* pix, intptr_t stride)
{
    if (svcntb() != 32) return 0ULL;
    svuint16_t v0001 = psv16_zero_u16();
    svuint16_t v0002 = psv16_zero_u16();
    svuint32_t v0003 = psv16_zero_u32();
    svuint32_t v0004 = psv16_zero_u32();
    svuint8_t v0005 = psv16_ld1b_zhi(pix + 0 * stride);
    svuint8_t v0006 = psv16_ld1b_zlo(pix + 1 * stride);
    svuint16_t v0007 = psv16_dual_vpadal_u8(v0001, v0005);
    svuint16_t v0008 = psv16_dual_vpadal_u8(v0002, v0006);
    svuint8_t v0009 = psv16_vget_lo8_u8(v0005);
    svuint8_t v0010 = psv16_vget_hi8_u8(v0005);
    svuint16_t v0011 = psv16_dual_vmull_u8(v0009, v0009);
    svuint16_t v0012 = psv16_dual_vmull_u8(v0010, v0010);
    svuint32_t v0013 = psv16_dual_vpadal_u16(v0003, v0011);
    svuint32_t v0014 = psv16_dual_vpadal_u16(v0013, v0012);
    svuint8_t v0015 = psv16_vget_lo8_u8(v0006);
    svuint8_t v0016 = psv16_vget_hi8_u8(v0006);
    svuint16_t v0017 = psv16_dual_vmull_u8(v0015, v0015);
    svuint16_t v0018 = psv16_dual_vmull_u8(v0016, v0016);
    svuint32_t v0019 = psv16_dual_vpadal_u16(v0004, v0017);
    svuint32_t v0020 = psv16_dual_vpadal_u16(v0019, v0018);
    svuint8_t v0021 = psv16_ld1b_zhi(pix + 2 * stride);
    svuint8_t v0022 = psv16_ld1b_zlo(pix + 3 * stride);
    svuint16_t v0023 = psv16_dual_vpadal_u8(v0007, v0021);
    svuint16_t v0024 = psv16_dual_vpadal_u8(v0008, v0022);
    svuint8_t v0025 = psv16_vget_lo8_u8(v0021);
    svuint8_t v0026 = psv16_vget_hi8_u8(v0021);
    svuint16_t v0027 = psv16_dual_vmull_u8(v0025, v0025);
    svuint16_t v0028 = psv16_dual_vmull_u8(v0026, v0026);
    svuint32_t v0029 = psv16_dual_vpadal_u16(v0014, v0027);
    svuint32_t v0030 = psv16_dual_vpadal_u16(v0029, v0028);
    svuint8_t v0031 = psv16_vget_lo8_u8(v0022);
    svuint8_t v0032 = psv16_vget_hi8_u8(v0022);
    svuint16_t v0033 = psv16_dual_vmull_u8(v0031, v0031);
    svuint16_t v0034 = psv16_dual_vmull_u8(v0032, v0032);
    svuint32_t v0035 = psv16_dual_vpadal_u16(v0020, v0033);
    svuint32_t v0036 = psv16_dual_vpadal_u16(v0035, v0034);
    svuint8_t v0037 = psv16_ld1b_zhi(pix + 4 * stride);
    svuint8_t v0038 = psv16_ld1b_zlo(pix + 5 * stride);
    svuint16_t v0039 = psv16_dual_vpadal_u8(v0023, v0037);
    svuint16_t v0040 = psv16_dual_vpadal_u8(v0024, v0038);
    svuint8_t v0041 = psv16_vget_lo8_u8(v0037);
    svuint8_t v0042 = psv16_vget_hi8_u8(v0037);
    svuint16_t v0043 = psv16_dual_vmull_u8(v0041, v0041);
    svuint16_t v0044 = psv16_dual_vmull_u8(v0042, v0042);
    svuint32_t v0045 = psv16_dual_vpadal_u16(v0030, v0043);
    svuint32_t v0046 = psv16_dual_vpadal_u16(v0045, v0044);
    svuint8_t v0047 = psv16_vget_lo8_u8(v0038);
    svuint8_t v0048 = psv16_vget_hi8_u8(v0038);
    svuint16_t v0049 = psv16_dual_vmull_u8(v0047, v0047);
    svuint16_t v0050 = psv16_dual_vmull_u8(v0048, v0048);
    svuint32_t v0051 = psv16_dual_vpadal_u16(v0036, v0049);
    svuint32_t v0052 = psv16_dual_vpadal_u16(v0051, v0050);
    svuint8_t v0053 = psv16_ld1b_zhi(pix + 6 * stride);
    svuint8_t v0054 = psv16_ld1b_zlo(pix + 7 * stride);
    svuint16_t v0055 = psv16_dual_vpadal_u8(v0039, v0053);
    svuint16_t v0056 = psv16_dual_vpadal_u8(v0040, v0054);
    svuint8_t v0057 = psv16_vget_lo8_u8(v0053);
    svuint8_t v0058 = psv16_vget_hi8_u8(v0053);
    svuint16_t v0059 = psv16_dual_vmull_u8(v0057, v0057);
    svuint16_t v0060 = psv16_dual_vmull_u8(v0058, v0058);
    svuint32_t v0061 = psv16_dual_vpadal_u16(v0046, v0059);
    svuint32_t v0062 = psv16_dual_vpadal_u16(v0061, v0060);
    svuint8_t v0063 = psv16_vget_lo8_u8(v0054);
    svuint8_t v0064 = psv16_vget_hi8_u8(v0054);
    svuint16_t v0065 = psv16_dual_vmull_u8(v0063, v0063);
    svuint16_t v0066 = psv16_dual_vmull_u8(v0064, v0064);
    svuint32_t v0067 = psv16_dual_vpadal_u16(v0052, v0065);
    svuint32_t v0068 = psv16_dual_vpadal_u16(v0067, v0066);
    svuint8_t v0069 = psv16_ld1b_zhi(pix + 8 * stride);
    svuint8_t v0070 = psv16_ld1b_zlo(pix + 9 * stride);
    svuint16_t v0071 = psv16_dual_vpadal_u8(v0055, v0069);
    svuint16_t v0072 = psv16_dual_vpadal_u8(v0056, v0070);
    svuint8_t v0073 = psv16_vget_lo8_u8(v0069);
    svuint8_t v0074 = psv16_vget_hi8_u8(v0069);
    svuint16_t v0075 = psv16_dual_vmull_u8(v0073, v0073);
    svuint16_t v0076 = psv16_dual_vmull_u8(v0074, v0074);
    svuint32_t v0077 = psv16_dual_vpadal_u16(v0062, v0075);
    svuint32_t v0078 = psv16_dual_vpadal_u16(v0077, v0076);
    svuint8_t v0079 = psv16_vget_lo8_u8(v0070);
    svuint8_t v0080 = psv16_vget_hi8_u8(v0070);
    svuint16_t v0081 = psv16_dual_vmull_u8(v0079, v0079);
    svuint16_t v0082 = psv16_dual_vmull_u8(v0080, v0080);
    svuint32_t v0083 = psv16_dual_vpadal_u16(v0068, v0081);
    svuint32_t v0084 = psv16_dual_vpadal_u16(v0083, v0082);
    svuint8_t v0085 = psv16_ld1b_zhi(pix + 10 * stride);
    svuint8_t v0086 = psv16_ld1b_zlo(pix + 11 * stride);
    svuint16_t v0087 = psv16_dual_vpadal_u8(v0071, v0085);
    svuint16_t v0088 = psv16_dual_vpadal_u8(v0072, v0086);
    svuint8_t v0089 = psv16_vget_lo8_u8(v0085);
    svuint8_t v0090 = psv16_vget_hi8_u8(v0085);
    svuint16_t v0091 = psv16_dual_vmull_u8(v0089, v0089);
    svuint16_t v0092 = psv16_dual_vmull_u8(v0090, v0090);
    svuint32_t v0093 = psv16_dual_vpadal_u16(v0078, v0091);
    svuint32_t v0094 = psv16_dual_vpadal_u16(v0093, v0092);
    svuint8_t v0095 = psv16_vget_lo8_u8(v0086);
    svuint8_t v0096 = psv16_vget_hi8_u8(v0086);
    svuint16_t v0097 = psv16_dual_vmull_u8(v0095, v0095);
    svuint16_t v0098 = psv16_dual_vmull_u8(v0096, v0096);
    svuint32_t v0099 = psv16_dual_vpadal_u16(v0084, v0097);
    svuint32_t v0100 = psv16_dual_vpadal_u16(v0099, v0098);
    svuint8_t v0101 = psv16_ld1b_zhi(pix + 12 * stride);
    svuint8_t v0102 = psv16_ld1b_zlo(pix + 13 * stride);
    svuint16_t v0103 = psv16_dual_vpadal_u8(v0087, v0101);
    svuint16_t v0104 = psv16_dual_vpadal_u8(v0088, v0102);
    svuint8_t v0105 = psv16_vget_lo8_u8(v0101);
    svuint8_t v0106 = psv16_vget_hi8_u8(v0101);
    svuint16_t v0107 = psv16_dual_vmull_u8(v0105, v0105);
    svuint16_t v0108 = psv16_dual_vmull_u8(v0106, v0106);
    svuint32_t v0109 = psv16_dual_vpadal_u16(v0094, v0107);
    svuint32_t v0110 = psv16_dual_vpadal_u16(v0109, v0108);
    svuint8_t v0111 = psv16_vget_lo8_u8(v0102);
    svuint8_t v0112 = psv16_vget_hi8_u8(v0102);
    svuint16_t v0113 = psv16_dual_vmull_u8(v0111, v0111);
    svuint16_t v0114 = psv16_dual_vmull_u8(v0112, v0112);
    svuint32_t v0115 = psv16_dual_vpadal_u16(v0100, v0113);
    svuint32_t v0116 = psv16_dual_vpadal_u16(v0115, v0114);
    svuint8_t v0117 = psv16_ld1b_zhi(pix + 14 * stride);
    svuint8_t v0118 = psv16_ld1b_zlo(pix + 15 * stride);
    svuint16_t v0119 = psv16_dual_vpadal_u8(v0103, v0117);
    svuint16_t v0120 = psv16_dual_vpadal_u8(v0104, v0118);
    svuint8_t v0121 = psv16_vget_lo8_u8(v0117);
    svuint8_t v0122 = psv16_vget_hi8_u8(v0117);
    svuint16_t v0123 = psv16_dual_vmull_u8(v0121, v0121);
    svuint16_t v0124 = psv16_dual_vmull_u8(v0122, v0122);
    svuint32_t v0125 = psv16_dual_vpadal_u16(v0110, v0123);
    svuint32_t v0126 = psv16_dual_vpadal_u16(v0125, v0124);
    svuint8_t v0127 = psv16_vget_lo8_u8(v0118);
    svuint8_t v0128 = psv16_vget_hi8_u8(v0118);
    svuint16_t v0129 = psv16_dual_vmull_u8(v0127, v0127);
    svuint16_t v0130 = psv16_dual_vmull_u8(v0128, v0128);
    svuint32_t v0131 = psv16_dual_vpadal_u16(v0116, v0129);
    svuint32_t v0132 = psv16_dual_vpadal_u16(v0131, v0130);
    svuint32_t v0133 = psv16_dual_vpaddl_u16(v0119);
    svuint32_t v0134 = psv16_dual_vpadal_u16(v0133, v0120);
    svuint32_t v0135 = svadd_u32_x(svptrue_b32(), v0126, v0132);
    uint32_t v0136 = psv16_reduce_u32(v0134);
    uint64_t v0137 = psv16_reduce_u32(v0135);
    uint64_t v0138 = (uint64_t)(uint32_t)v0136 | ((uint64_t)v0137 << 32);
    return v0138;
}
