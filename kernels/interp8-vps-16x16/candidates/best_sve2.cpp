    ...
    int16_t* dst, intptr_t dstride, int coeffIdx)
{
    switch (coeffIdx)
    {
    case 1: vps_impl_1<1, 16, 16>(src, sstride, dst, dstride); break;
    case 2: vps_impl_2<2, 16, 16>(src, sstride, dst, dstride); break;
    default: vps_impl_3<3, 16, 16>(src, sstride, dst, dstride); break;
    }
}
