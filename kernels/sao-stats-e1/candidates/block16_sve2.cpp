...
extern "C" void dynopt_sao_stats_e1_64_sve2(const int16_t* diff, const uint8_t* rec, intptr_t stride, int8_t* upBuff1, int32_t* stats, int32_t* count)
{
    ...
    {
        int8x16_t su = vld1q_s8(upBuff1 + 0);
        int8x16_t sd = sign16n(rec + 0, rec + 0 + stride);
        int8x16_t et = vsubq_s8(sd, su);
        vst1q_s8(upBuff1 + 0, sd);
 ...
 vdupq_n_s8(2)));
    ...
    {
        int8x16_t su = vld1q_s8(upBuff1 + 16);
        int8x16_t sd = sign16n(rec + 16, rec + 16 + stride);
        int8x16_t et = vsubq_s8(sd, su);
        vst1q_s8(upBuff1 + 16, sd);
        svint8_t svet = svset_neonq_s8(svundef_s8(), et);
        count_u8 = vaddq_u8(count_u8,
            svget_neonq_u8(svhistseg_s8(svidx, svet)));
        int8x16_t m0 = vreinterpretq_s8_u8(vceqq_s8(et,
 ...
 vdupq_n_s8(2)));
    ...
    {
        int8x16_t su = vld1q_s8(upBuff1 + 32);
        int8x16_t sd = sign16n(rec + 32, rec + 32 + stride);
        int8x16_t et = vsubq_s8(sd, su);
        vst1q_s8(upBuff1 + 32, sd);
        svint8_t svet = svset_neonq_s8(svundef_s8(), et);
        count_u8 = vaddq_u8(count_u8,
            svget_neonq_u8(svhistseg_s8(svidx, svet)));
        int8x16_t m0 = vreinterpretq_s8_u8(vceqq_s8(et,
 ...
 vdupq_n_s8(2)));
    ...
    {
        int8x16_t su = vld1q_s8(upBuff1 + 48);
        int8x16_t sd = sign16n(rec + 48, rec + 48 + stride);
        int8x16_t et = vsubq_s8(sd, su);
        vst1q_s8(upBuff1 + 48, sd);
        svint8_t svet = svset_neonq_s8(svundef_s8(), et);
        count_u8 = vaddq_u8(count_u8,
            svget_neonq_u8(svhistseg_s8(svidx, svet)));
        int8x16_t m0 = vreinterpretq_s8_u8(vceqq_s8(et,
