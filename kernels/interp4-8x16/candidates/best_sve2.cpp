...
// Chroma 4-tap horizontal 8x16 (SVE2p3, VL=256).
#include <arm_sve.h>
...
extern "C" void dynopt_interp4_8x16_sve2(const uint8_t* src, intptr_t srcStride,
                   uint8_t* dst, intptr_t dstStride, int coeffIdx)
{
    ...
    for (int r = 0; r < 16; r++)
    {
        ...
        for (int u = 0; u < 1; u++)
        {
            ...
            svst1_u8(8 < 16 ? p8b : p16b, drow + u * 16, uz);
        }
    }
}
