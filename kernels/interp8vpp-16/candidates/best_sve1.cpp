...
extern "C" void dynopt_interp8_16x16_sve2_vpp(const uint8_t* src, intptr_t srcStride, uint8_t* dst, intptr_t dstStride, int coeffIdx)
{
    ...
    const svbool_t pg = svwhilelt_b8((uint32_t)0, (uint32_t)16);
    ...
    svunpklo_u16(rr22));
{
    ...
    uint8x16_t out = vcombine_u8(vqrshrun_n_s16(svget_neonq_s16(sum), 6), vqrshrun_n_s16(svget_neonq_s16(svtbl_s16(sum, hi8)), 6));
    svst1_u8(pg, dst + 0 * dstStride, svset_neonq_u8(svundef_u8(), out));
}
{
    svint16_t sum = svdup_n_s16(0);
    int c0 = cf[0];
    ...
    uint8x16_t out = vcombine_u8(vqrshrun_n_s16(svget_neonq_s16(sum), 6), vqrshrun_n_s16(svget_neonq_s16(svtbl_s16(sum, hi8)), 6));
    svst1_u8(pg, dst + 1 * dstStride, svset_neonq_u8(svundef_u8(), out));
}
{
    svint16_t sum = svdup_n_s16(0);
    int c0 = cf[0];
    ...
    uint8x16_t out = vcombine_u8(vqrshrun_n_s16(svget_neonq_s16(sum), 6), vqrshrun_n_s16(svget_neonq_s16(svtbl_s16(sum, hi8)), 6));
    svst1_u8(pg, dst + 2 * dstStride, svset_neonq_u8(svundef_u8(), out));
}
{
    svint16_t sum = svdup_n_s16(0);
    int c0 = cf[0];
    ...
    uint8x16_t out = vcombine_u8(vqrshrun_n_s16(svget_neonq_s16(sum), 6), vqrshrun_n_s16(svget_neonq_s16(svtbl_s16(sum, hi8)), 6));
    svst1_u8(pg, dst + 3 * dstStride, svset_neonq_u8(svundef_u8(), out));
}
{
    svint16_t sum = svdup_n_s16(0);
    int c0 = cf[0];
    ...
    uint8x16_t out = vcombine_u8(vqrshrun_n_s16(svget_neonq_s16(sum), 6), vqrshrun_n_s16(svget_neonq_s16(svtbl_s16(sum, hi8)), 6));
    svst1_u8(pg, dst + 4 * dstStride, svset_neonq_u8(svundef_u8(), out));
}
{
    svint16_t sum = svdup_n_s16(0);
    int c0 = cf[0];
    ...
    uint8x16_t out = vcombine_u8(vqrshrun_n_s16(svget_neonq_s16(sum), 6), vqrshrun_n_s16(svget_neonq_s16(svtbl_s16(sum, hi8)), 6));
    svst1_u8(pg, dst + 5 * dstStride, svset_neonq_u8(svundef_u8(), out));
}
{
    svint16_t sum = svdup_n_s16(0);
    int c0 = cf[0];
    ...
    uint8x16_t out = vcombine_u8(vqrshrun_n_s16(svget_neonq_s16(sum), 6), vqrshrun_n_s16(svget_neonq_s16(svtbl_s16(sum, hi8)), 6));
    svst1_u8(pg, dst + 6 * dstStride, svset_neonq_u8(svundef_u8(), out));
}
{
    svint16_t sum = svdup_n_s16(0);
    int c0 = cf[0];
    ...
    uint8x16_t out = vcombine_u8(vqrshrun_n_s16(svget_neonq_s16(sum), 6), vqrshrun_n_s16(svget_neonq_s16(svtbl_s16(sum, hi8)), 6));
    svst1_u8(pg, dst + 7 * dstStride, svset_neonq_u8(svundef_u8(), out));
}
{
    svint16_t sum = svdup_n_s16(0);
    int c0 = cf[0];
    ...
    uint8x16_t out = vcombine_u8(vqrshrun_n_s16(svget_neonq_s16(sum), 6), vqrshrun_n_s16(svget_neonq_s16(svtbl_s16(sum, hi8)), 6));
    svst1_u8(pg, dst + 8 * dstStride, svset_neonq_u8(svundef_u8(), out));
}
{
    svint16_t sum = svdup_n_s16(0);
    int c0 = cf[0];
    ...
    uint8x16_t out = vcombine_u8(vqrshrun_n_s16(svget_neonq_s16(sum), 6), vqrshrun_n_s16(svget_neonq_s16(svtbl_s16(sum, hi8)), 6));
    svst1_u8(pg, dst + 9 * dstStride, svset_neonq_u8(svundef_u8(), out));
}
{
    svint16_t sum = svdup_n_s16(0);
    int c0 = cf[0];
    ...
    uint8x16_t out = vcombine_u8(vqrshrun_n_s16(svget_neonq_s16(sum), 6), vqrshrun_n_s16(svget_neonq_s16(svtbl_s16(sum, hi8)), 6));
    svst1_u8(pg, dst + 10 * dstStride, svset_neonq_u8(svundef_u8(), out));
}
{
    svint16_t sum = svdup_n_s16(0);
    int c0 = cf[0];
    ...
    uint8x16_t out = vcombine_u8(vqrshrun_n_s16(svget_neonq_s16(sum), 6), vqrshrun_n_s16(svget_neonq_s16(svtbl_s16(sum, hi8)), 6));
    svst1_u8(pg, dst + 11 * dstStride, svset_neonq_u8(svundef_u8(), out));
}
{
    svint16_t sum = svdup_n_s16(0);
    int c0 = cf[0];
    ...
    uint8x16_t out = vcombine_u8(vqrshrun_n_s16(svget_neonq_s16(sum), 6), vqrshrun_n_s16(svget_neonq_s16(svtbl_s16(sum, hi8)), 6));
    svst1_u8(pg, dst + 12 * dstStride, svset_neonq_u8(svundef_u8(), out));
}
{
    svint16_t sum = svdup_n_s16(0);
    int c0 = cf[0];
    ...
    uint8x16_t out = vcombine_u8(vqrshrun_n_s16(svget_neonq_s16(sum), 6), vqrshrun_n_s16(svget_neonq_s16(svtbl_s16(sum, hi8)), 6));
    svst1_u8(pg, dst + 13 * dstStride, svset_neonq_u8(svundef_u8(), out));
}
{
    svint16_t sum = svdup_n_s16(0);
    int c0 = cf[0];
    ...
    uint8x16_t out = vcombine_u8(vqrshrun_n_s16(svget_neonq_s16(sum), 6), vqrshrun_n_s16(svget_neonq_s16(svtbl_s16(sum, hi8)), 6));
    svst1_u8(pg, dst + 14 * dstStride, svset_neonq_u8(svundef_u8(), out));
}
{
    svint16_t sum = svdup_n_s16(0);
    int c0 = cf[0];
    ...
    uint8x16_t out = vcombine_u8(vqrshrun_n_s16(svget_neonq_s16(sum), 6), vqrshrun_n_s16(svget_neonq_s16(svtbl_s16(sum, hi8)), 6));
    svst1_u8(pg, dst + 15 * dstStride, svset_neonq_u8(svundef_u8(), out));
}
}
