...
// 8-bit horizontal 8-tap luma filter 64x64 (SVE2p3,
// VL=256), path B.
#include <arm_sve.h>
...
extern "C" void dynopt_interp8_64x64_sve2(const uint8_t* src, intptr_t srcStride,
...
#pragma clang loop unroll(full)
    for (int r = 0; r < 64; r++)
    {
        ...
        svuint8_t W32_0 = svld1_u8(p32, row);
        svuint8_t W32_1 = svld1_u8(p32, row + 24);
        svuint8_t W32_2 = svld1_u8(p32, row + 48);
        svint8_t W_0 = svreinterpret_s8_u8(
            svsub_n_u8_x(svptrue_b8(), W32_0, 128));
        svint8_t W_1 = svreinterpret_s8_u8(
            svsub_n_u8_x(svptrue_b8(), W32_1, 128));
        svint8_t W_2 = svreinterpret_s8_u8(
            svsub_n_u8_x(svptrue_b8(), W32_2, 128));
        uint8_t* drow = dst + r * dstStride;
        interp8_unit8(W_0, ix0, ix1, c0, c1, off4096, drow + 0, p8h8);
        interp8_unit8(W_0, ix0_8, ix1_8, c0, c1, off4096, drow + 8, p8h8);
        interp8_unit8(W_0, ix0_16, ix1_16, c0, c1, off4096, drow + 16, p8h8);
        interp8_unit8(W_1, ix0, ix1, c0, c1, off4096, drow + 24, p8h8);
        interp8_unit8(W_1, ix0_8, ix1_8, c0, c1, off4096, drow + 32, p8h8);
        interp8_unit8(W_1, ix0_16, ix1_16, c0, c1, off4096, drow + 40, p8h8);
        interp8_unit8(W_2, ix0, ix1, c0, c1, off4096, drow + 48, p8h8);
        interp8_unit8(W_2, ix0_8, ix1_8, c0, c1, off4096, drow + 56, p8h8);
    }
}
