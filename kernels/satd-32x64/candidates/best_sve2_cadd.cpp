// SATD 32x64 SVE2 candidate: native SVE2 cadd butterfly (950-only).
//
// 2 half-vectors per row x 4-row quads of the verified satd-16 cadd
// kernel; gate-arbitrated vs x265::satd8_sve2<32,64>.
...
extern "C" int dynopt_satd_32x64_sve2(const uint8_t* pix1, intptr_t sp1,
