...
extern "C" void dynopt_sao_stats_e3_64_sve2(const int16_t* diff, const uint8_t* rec, intptr_t stride, int8_t* upBuff1, int32_t* stats, int32_t* count)
{
    ...
    for (int x = 0; x < 64; x += 32)
    {
        ...
        // E3 (45deg diagonal): sign_down compares rec[x] with the
        // diagonal neighbor rec[x + stride - 1] (E1 used +stride).
