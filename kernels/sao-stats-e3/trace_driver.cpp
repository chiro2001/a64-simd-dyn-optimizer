// Single-invocation driver for QEMU tracing (SAO stats E3 64).
#include <cstdint>

extern "C" void dynopt_sao_stats_e3_64_sve2(
...
int main()
{
    ...
    for (int i = 0; i < 70; i++)
        up[i] = (int8_t)(i % 3) - 1;
    dynopt_sao_stats_e3_64_sve2(diff, rec + 8, 64, up + 1, stats, count);
    return stats[0] == 0x7f;
}
