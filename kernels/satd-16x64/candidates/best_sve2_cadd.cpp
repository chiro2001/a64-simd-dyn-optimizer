// SATD 16x64 SVE2 candidate: native SVE2 cadd butterfly (950-only).
//
// Vertical extension of the verified satd-16 cadd kernel
// (best_sve2_cadd.cpp): 64 rows = 16 quads of 4 rows (g-loop x2),
// same ROWH4 horizontal 4-point cadd butterfly on 16-lane rows.
// Bit-exact vs x265::satd8_sve2<16,64> expected by construction
...
extern "C" int dynopt_satd_16x64_sve2(const uint8_t* pix1, intptr_t sp1,
