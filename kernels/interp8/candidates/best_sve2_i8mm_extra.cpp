...
// Non-square luma shapes dispatched by x265's i8mm primitive table
// (filter-neon-i8mm.cpp LUMA_I8MM).  Same generic WxH template.
#ifdef I8MM_ONLY_W
#define I8MM_WRAPPER_EVAL(W, H) I8MM_WRAPPER(W, H)
I8MM_WRAPPER_EVAL(I8MM_ONLY_W, I8MM_ONLY_H)
#undef I8MM_WRAPPER_EVAL
#else
I8MM_WRAPPER(16, 8)
I8MM_WRAPPER(8, 16)
I8MM_WRAPPER(32, 16)
