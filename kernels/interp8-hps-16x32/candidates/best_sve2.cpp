...
static void hps_impl_1(const uint8_t* src, intptr_t sstride,
...
template<int CI, int W, int H>
static void hps_impl_2(const uint8_t* src, intptr_t sstride,
                            int16_t* dst, intptr_t dstride, int isRowExt)
{
    const int offset = (unsigned)-8192;
    int blkheight = H;
...
template<int CI, int W, int H>
static void hps_impl_3(const uint8_t* src, intptr_t sstride,
                            int16_t* dst, intptr_t dstride, int isRowExt)
{
    const int offset = (unsigned)-8192;
    int blkheight = H;
    ...
    int16_t* dst, intptr_t dstride, int coeffIdx, int isRowExt)
{
    switch (coeffIdx)
    {
    case 1: hps_impl_1<1, 16, 32>(src, sstride, dst, dstride, isRowExt); break;
    case 2: hps_impl_2<2, 16, 32>(src, sstride, dst, dstride, isRowExt); break;
    default: hps_impl_3<3, 16, 32>(src, sstride, dst, dstride, isRowExt); break;
    }
}
