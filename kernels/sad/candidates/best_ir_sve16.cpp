...
extern "C" int dynopt_sad_16x16_sve16(const uint8_t* pix1, intptr_t stride1, const uint8_t* pix2, intptr_t stride2)
{
    ...
    svuint8_t v0007 = psv16_vget_hi8_u8(v0003);
    svuint8_t v0008 = psv16_vget_hi8_u8(v0004);
    svuint16_t v0009 = psv16_dual_vabal_u8(v0001, v0005, v0006);
    svuint16_t v0010 = psv16_dual_vabal_u8(v0002, v0007, v0008);
    svuint8_t v0011 = psv16_ld1b_zlo(pix1 + 1 * stride1);
    svuint8_t v0012 = psv16_ld1b_zlo(pix2 + 1 * stride2);
    svuint8_t v0013 = psv16_vget_lo8_u8(v0011);
    svuint8_t v0014 = psv16_vget_lo8_u8(v0012);
    svuint8_t v0015 = psv16_vget_hi8_u8(v0011);
    svuint8_t v0016 = psv16_vget_hi8_u8(v0012);
    svuint16_t v0017 = psv16_dual_vabal_u8(v0009, v0013, v0014);
    svuint16_t v0018 = psv16_dual_vabal_u8(v0010, v0015, v0016);
    svuint8_t v0019 = psv16_ld1b_zhi(pix1 + 2 * stride1);
    svuint8_t v0020 = psv16_ld1b_zhi(pix2 + 2 * stride2);
    svuint8_t v0021 = psv16_vget_lo8_u8(v0019);
    svuint8_t v0022 = psv16_vget_lo8_u8(v0020);
    svuint8_t v0023 = psv16_vget_hi8_u8(v0019);
    svuint8_t v0024 = psv16_vget_hi8_u8(v0020);
    svuint16_t v0025 = psv16_dual_vabal_u8(v0017, v0021, v0022);
    svuint16_t v0026 = psv16_dual_vabal_u8(v0018, v0023, v0024);
    svuint8_t v0027 = psv16_ld1b_zlo(pix1 + 3 * stride1);
    svuint8_t v0028 = psv16_ld1b_zlo(pix2 + 3 * stride2);
    svuint8_t v0029 = psv16_vget_lo8_u8(v0027);
    svuint8_t v0030 = psv16_vget_lo8_u8(v0028);
    svuint8_t v0031 = psv16_vget_hi8_u8(v0027);
    svuint8_t v0032 = psv16_vget_hi8_u8(v0028);
    svuint16_t v0033 = psv16_dual_vabal_u8(v0025, v0029, v0030);
    svuint16_t v0034 = psv16_dual_vabal_u8(v0026, v0031, v0032);
    svuint8_t v0035 = psv16_ld1b_zhi(pix1 + 4 * stride1);
    svuint8_t v0036 = psv16_ld1b_zhi(pix2 + 4 * stride2);
    svuint8_t v0037 = psv16_vget_lo8_u8(v0035);
    svuint8_t v0038 = psv16_vget_lo8_u8(v0036);
    svuint8_t v0039 = psv16_vget_hi8_u8(v0035);
    svuint8_t v0040 = psv16_vget_hi8_u8(v0036);
    svuint16_t v0041 = psv16_dual_vabal_u8(v0033, v0037, v0038);
    svuint16_t v0042 = psv16_dual_vabal_u8(v0034, v0039, v0040);
    svuint8_t v0043 = psv16_ld1b_zlo(pix1 + 5 * stride1);
    svuint8_t v0044 = psv16_ld1b_zlo(pix2 + 5 * stride2);
    svuint8_t v0045 = psv16_vget_lo8_u8(v0043);
    svuint8_t v0046 = psv16_vget_lo8_u8(v0044);
    svuint8_t v0047 = psv16_vget_hi8_u8(v0043);
    svuint8_t v0048 = psv16_vget_hi8_u8(v0044);
    svuint16_t v0049 = psv16_dual_vabal_u8(v0041, v0045, v0046);
    svuint16_t v0050 = psv16_dual_vabal_u8(v0042, v0047, v0048);
    svuint8_t v0051 = psv16_ld1b_zhi(pix1 + 6 * stride1);
    svuint8_t v0052 = psv16_ld1b_zhi(pix2 + 6 * stride2);
    svuint8_t v0053 = psv16_vget_lo8_u8(v0051);
    svuint8_t v0054 = psv16_vget_lo8_u8(v0052);
    svuint8_t v0055 = psv16_vget_hi8_u8(v0051);
    svuint8_t v0056 = psv16_vget_hi8_u8(v0052);
    svuint16_t v0057 = psv16_dual_vabal_u8(v0049, v0053, v0054);
    svuint16_t v0058 = psv16_dual_vabal_u8(v0050, v0055, v0056);
    svuint8_t v0059 = psv16_ld1b_zlo(pix1 + 7 * stride1);
    svuint8_t v0060 = psv16_ld1b_zlo(pix2 + 7 * stride2);
    svuint8_t v0061 = psv16_vget_lo8_u8(v0059);
    svuint8_t v0062 = psv16_vget_lo8_u8(v0060);
    svuint8_t v0063 = psv16_vget_hi8_u8(v0059);
    svuint8_t v0064 = psv16_vget_hi8_u8(v0060);
    svuint16_t v0065 = psv16_dual_vabal_u8(v0057, v0061, v0062);
    svuint16_t v0066 = psv16_dual_vabal_u8(v0058, v0063, v0064);
    svuint8_t v0067 = psv16_ld1b_zhi(pix1 + 8 * stride1);
    svuint8_t v0068 = psv16_ld1b_zhi(pix2 + 8 * stride2);
    svuint8_t v0069 = psv16_vget_lo8_u8(v0067);
    svuint8_t v0070 = psv16_vget_lo8_u8(v0068);
    svuint8_t v0071 = psv16_vget_hi8_u8(v0067);
    svuint8_t v0072 = psv16_vget_hi8_u8(v0068);
    svuint16_t v0073 = psv16_dual_vabal_u8(v0065, v0069, v0070);
    svuint16_t v0074 = psv16_dual_vabal_u8(v0066, v0071, v0072);
    svuint8_t v0075 = psv16_ld1b_zlo(pix1 + 9 * stride1);
    svuint8_t v0076 = psv16_ld1b_zlo(pix2 + 9 * stride2);
    svuint8_t v0077 = psv16_vget_lo8_u8(v0075);
    svuint8_t v0078 = psv16_vget_lo8_u8(v0076);
    svuint8_t v0079 = psv16_vget_hi8_u8(v0075);
    svuint8_t v0080 = psv16_vget_hi8_u8(v0076);
    svuint16_t v0081 = psv16_dual_vabal_u8(v0073, v0077, v0078);
    svuint16_t v0082 = psv16_dual_vabal_u8(v0074, v0079, v0080);
    svuint8_t v0083 = psv16_ld1b_zhi(pix1 + 10 * stride1);
    svuint8_t v0084 = psv16_ld1b_zhi(pix2 + 10 * stride2);
    svuint8_t v0085 = psv16_vget_lo8_u8(v0083);
    svuint8_t v0086 = psv16_vget_lo8_u8(v0084);
    svuint8_t v0087 = psv16_vget_hi8_u8(v0083);
    svuint8_t v0088 = psv16_vget_hi8_u8(v0084);
    svuint16_t v0089 = psv16_dual_vabal_u8(v0081, v0085, v0086);
    svuint16_t v0090 = psv16_dual_vabal_u8(v0082, v0087, v0088);
    svuint8_t v0091 = psv16_ld1b_zlo(pix1 + 11 * stride1);
    svuint8_t v0092 = psv16_ld1b_zlo(pix2 + 11 * stride2);
    svuint8_t v0093 = psv16_vget_lo8_u8(v0091);
    svuint8_t v0094 = psv16_vget_lo8_u8(v0092);
    svuint8_t v0095 = psv16_vget_hi8_u8(v0091);
    svuint8_t v0096 = psv16_vget_hi8_u8(v0092);
    svuint16_t v0097 = psv16_dual_vabal_u8(v0089, v0093, v0094);
    svuint16_t v0098 = psv16_dual_vabal_u8(v0090, v0095, v0096);
    svuint8_t v0099 = psv16_ld1b_zhi(pix1 + 12 * stride1);
    svuint8_t v0100 = psv16_ld1b_zhi(pix2 + 12 * stride2);
    svuint8_t v0101 = psv16_vget_lo8_u8(v0099);
    svuint8_t v0102 = psv16_vget_lo8_u8(v0100);
    svuint8_t v0103 = psv16_vget_hi8_u8(v0099);
    svuint8_t v0104 = psv16_vget_hi8_u8(v0100);
    svuint16_t v0105 = psv16_dual_vabal_u8(v0097, v0101, v0102);
    svuint16_t v0106 = psv16_dual_vabal_u8(v0098, v0103, v0104);
    svuint8_t v0107 = psv16_ld1b_zlo(pix1 + 13 * stride1);
    svuint8_t v0108 = psv16_ld1b_zlo(pix2 + 13 * stride2);
    svuint8_t v0109 = psv16_vget_lo8_u8(v0107);
    svuint8_t v0110 = psv16_vget_lo8_u8(v0108);
    svuint8_t v0111 = psv16_vget_hi8_u8(v0107);
    svuint8_t v0112 = psv16_vget_hi8_u8(v0108);
    svuint16_t v0113 = psv16_dual_vabal_u8(v0105, v0109, v0110);
    svuint16_t v0114 = psv16_dual_vabal_u8(v0106, v0111, v0112);
    svuint8_t v0115 = psv16_ld1b_zhi(pix1 + 14 * stride1);
    svuint8_t v0116 = psv16_ld1b_zhi(pix2 + 14 * stride2);
    svuint8_t v0117 = psv16_vget_lo8_u8(v0115);
    svuint8_t v0118 = psv16_vget_lo8_u8(v0116);
    svuint8_t v0119 = psv16_vget_hi8_u8(v0115);
    svuint8_t v0120 = psv16_vget_hi8_u8(v0116);
    svuint16_t v0121 = psv16_dual_vabal_u8(v0113, v0117, v0118);
    svuint16_t v0122 = psv16_dual_vabal_u8(v0114, v0119, v0120);
    svuint8_t v0123 = psv16_ld1b_zlo(pix1 + 15 * stride1);
    svuint8_t v0124 = psv16_ld1b_zlo(pix2 + 15 * stride2);
    svuint8_t v0125 = psv16_vget_lo8_u8(v0123);
    svuint8_t v0126 = psv16_vget_lo8_u8(v0124);
    svuint8_t v0127 = psv16_vget_hi8_u8(v0123);
    svuint8_t v0128 = psv16_vget_hi8_u8(v0124);
    svuint16_t v0129 = psv16_dual_vabal_u8(v0121, v0125, v0126);
    svuint16_t v0130 = psv16_dual_vabal_u8(v0122, v0127, v0128);
    int32_t v0131 = psv16_reduce_u16_u32(v0129);
    int32_t v0132 = psv16_reduce_u16_u32(v0130);
    int32_t v0133 = v0131 + v0132;
    return v0133;
}
