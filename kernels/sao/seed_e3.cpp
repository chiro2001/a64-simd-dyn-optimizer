// SAO edge offset class 3 (diagonal 45deg), 64x1 NEON seed (docs/45).
// Mirrors processSaoCUE3_neon with startX=0/endX=64: vector blocks
// x=1..49 (1..56), scalar tail x=57..63 (dynamic offsetEo lookup).
#include <arm_neon.h>
...
extern "C" void dynopt_sao_e3_64(
