...
// NEON processSaoCUE1_neon (per-row calls, 64x4) and a C baseline.
#include <cstdint>
#include <cstdio>
#include <cstdlib>
#include <cstring>
...
#define DYNOPT_CANDIDATE dynopt_sao_e1_64x4_roundtrip
#endif
...
int main(int argc, char** argv)
{
    ...
    {
        uint8_t src[5 * 128 + 16], a[5 * 128 + 16], b[5 * 128 + 16];
        ...
        ref_c(a, up1, off, 64, 4, stride);
        for (int y = 0; y < 4; y++)
            processSaoCUE1_neon(b + y * stride, up2, off, stride, 64);
