// SAO edge offset class 1 (vertical), 64x1 NEON — slot-safe: x265
// saoCuOrgE1 is a SINGLE-row primitive (processSaoCUE1).  The 64x4
// seed (best_e1.cpp) is a batch extension, not dispatch-safe.
#include <arm_neon.h>
#include <stdint.h>
