// SAO band offset, 64x4 NEON (slot-safe for saoCuOrgB0: the inject
// adapter loops y+=4 over this 4-row kernel).  Mirrors the original
// seed best_b0.cpp: offset index = pixel >> 3 (8-bit), 32-byte table
// via vtbl4, rec = clip(rec + offset[index]).
#include <arm_neon.h>
#include <stdint.h>
