// SAO edge offset class 2 (diagonal 135deg), 64x1 NEON seed (docs/45).
// Mirrors processSaoCUE2_neon: signDown = sign(rec[x]-rec[x+stride+1]),
// edgeType = signDown + buff1[x] + 2, bufft[x+1] = -signDown,
// rec = clip(rec + offsetEo[edgeType]).
#include <arm_neon.h>

#include <stddef.h>
#include <stdint.h>

static inline int8x8_t sao_sign2(uint8x8_t a, uint8x8_t b)
{
...
extern "C" void dynopt_sao_e2_64(
