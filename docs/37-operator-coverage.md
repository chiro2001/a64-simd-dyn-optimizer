...
| **quant** | 4（quant/nquant/dequant_scaling/dequant_normal） | dequant_normal ✅（130/57）；dequant_scaling ✅（gt 210/75、le 193/72）；**quant ✅（508/169）** | **首选下一族**（纯汇编，走 C/ACLE seed 模式；docs/44） |
