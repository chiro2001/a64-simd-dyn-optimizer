...
| sa8d/satd | （嵌套） | sa8d 8/16；**satd 全 7 形状 ✅（通用 hadamard 配方：4x4 37/57、4x8 63/62、8x4 47/43、8x8 93/51、8x16 185/70、16x8 183/69、16x16 441/133）** | satd 8x32 等大形状（需循环导入支持） |
