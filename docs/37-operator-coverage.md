...
| interp8 | （嵌套 luma_*） | hpp 8/16/32；**vpp 8/16/32 ✅（通用 vertical-fir 配方）**；**hps 8x8/8x16/16x16/32x32 ✅（fir-ps 配方）**；**vps 8x8/16x16/32x32 ✅（vertical-ps 配方：8x8 118/78、16x16 214/136、32x32 808/479）**（vertical-ps 配方：16x16 214/136、32x32 808/479）** | hps isRowExt=1 契约 ✅（fir-ps ext）；**vss 8x8/16x16/32x32 ✅（vertical-ss 配方：8x8 224/97、16x16 872/297、32x32 3464/1056）**；**vsp 8x8/16x16/32x32 ✅（vertical-sp 配方：8x8 241/107、16x16 938/317、32x32 3725/1137）**；luma_* 四个 short 变体全部有首覆盖（docs/40 §40） |
