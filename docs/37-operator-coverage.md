...
| sa8d/satd | （嵌套） | sa8d 8/16；**satd 21 形状 ✅（通用 hadamard 配方：4x4 37/57、4x8 63/62、8x4 47/43、8x8 52/53、8x16 102/69、8x32 202/91、16x4 36/43、16x8 72/53、16x16 140/74、16x32 276/106、16x64 548/174、32x8 141/68、32x16 281/101、32x32 561/166、32x64 1121/298、64x16 561/168、64x32 1121/298、48x64 1681/426、64x48 1681/427、24x32 607/215、64x64 2241/554）** | 大形状已收口到 64x64 ✅ |
| interp8 | （嵌套 luma_*） | hpp 8/16/32；**vpp 8/16/32 ✅（通用 vertical-fir 配方）**；**hps 8x8/8x16/16x16/32x32 ✅（fir-ps 配方）**；**vps 8x4/16x4/8x8/8x16/16x16/16x32/32x16/32x32 ✅（vertical-ps 配方：8x8 118/78、16x16 214/136、32x32 808/479）**（vertical-ps 配方：16x16 214/136、32x32 808/479）** | hps isRowExt=1 契约 ✅（fir-ps ext）；**vss 8x4/16x4/8x8/8x16/16x16/16x32/32x16/32x32 ✅（vertical-ss 配方：8x8 224/97、16x16 872/297、32x32 3464/1056）**；**vsp 8x4/16x4/8x8/8x16/16x16/16x32/32x16/32x32 ✅（vertical-sp 配方：8x8 241/107、16x16 938/317、32x32 3725/1137）**；luma_* 四个 short 变体全部有首覆盖（docs/40 §40） |
...
| misc | findPosFirstLast/costCoeffNxN/scanPosLast/**weight_pp ✅（weight-pp 配方 64x32 branch-0，642/213）**/**planecopy_cp ✅（128/60）** | 其余无 | 小算子，收益低 |
