...
| interp8 | （嵌套 luma_*） | hpp 8/16/32；**vpp 8/16/32 ✅（通用 vertical-fir 配方）**；**hps 8x8/8x16/16x16/32x32 ✅（fir-ps 配方）**；**vps 16x16/32x32 ✅（vertical-ps 配方：16x16 214/136、32x32 808/479）** | hps isRowExt=1 契约 ✅（fir-ps ext：8x8 175/68、8x16 263/92、16x16 516/159、32x32 1726/606）；缺 vsp/vss（docs/40 §38） |
