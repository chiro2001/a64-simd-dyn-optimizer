...
- **DCT32 op 后端 best = 4874 fused_uop**（vector 5350 / movprfx 476 /
  stack 530 / 零 scatter），相对上游 12710 = 0.383×，距内部参考
  4827（fused_adj 4251）= 1.010×。由 row16 合并存储 + k0_merge8
  新轴 + k0 先发射（live-range 缩短）达成（5390→4874，-9.6%），
  全布局搜索 112 候选确认，
