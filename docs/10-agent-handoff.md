...
- **DCT32 op 后端 best = 4944 fused_uop**（vector 5416 / movprfx 472 /
  stack 614 / 零 scatter），相对上游 12710 = 0.389×，距内部参考
  4827（fused_adj 4251）= 1.024×。由 row16 合并存储 + k0_merge8
  新轴达成（5390→4944，-8.3%），全布局搜索 112 候选确认，
