...
100 帧长片段（920B）：**-1.94%**（22359 vs 21942 ms，bootstrap
[375,514]ms 不含 0，bit-exact 1600c2fa）——显著性确认，与 30 帧
一致。

N1 同片段：**-1.20%**（32978 vs 32604 ms，CI [52,797]ms，
bit-exact 07450372…），与 30 帧 -1.62% 噪声内一致。
