// AGO M2 paired microbench: upstream NEON satd 8x8 vs AGO cover output.
// Usage: ago_satd8_microbench <neon|cand> [samples=100] [batch=16384]
...
int main(int argc, char** argv)
{
    ...
    pixelcmp_t neon = primitives.pu[LUMA_8x8].satd;
    ...
    for (int t = 0; t < 1000; t++)
    {
        ...
        int g = dynopt_ago_satd8(pa, 16, pb, 16);
        if (n != g)
            bad++;
    }
    ...
    printf("ago_satd8,%s,verify_bad=%d,median_total=%llu\n",
           which ? "cand" : "neon", bad,
