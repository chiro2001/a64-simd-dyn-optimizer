// CNTVCT paired for inlined interp8 hps 16x16 (coeffIdx=3).
#include <algorithm>
#include <cstdint>
#include <cstdio>
#include <cstring>
...
extern "C" void dynopt_interp8_hps_16x16_sve2(
...
int main(int argc, char** argv)
{
    ...
    filter_hps_t ref = primitives.pu[LUMA_16x16].luma_hps;
    std::mt19937 rng(0x4E99u);
    ...
    for (int t = 0; t < 2000; t++)
    {
        ...
        ref(pa, 128, r, 16, 3, 0);
        dynopt_interp8_hps_16x16_sve2(pa, 128, g, 16, 3, 0);
        if (std::memcmp(r, g, 16 * 16 * 2) != 0)
            bad++;
    }
    ...
    printf("interp8_hps16,%s,verify_bad=%d,median_total=%llu\n",
           which ? "cand" : "neon", bad,
