...
## interp8 vsp 验证（2026-08-16 负结果）

- [x] filter8_s16x8 外链确认存在，内联候选 36 万差分 0 失配，但
  920B paired 1.00x/0.96x **无收益**（helper 体大、外链占比小）；
- [x] 外链修复线全部收尾；920B/N1 保持 best8（-1.92%/-1.78%），
  等待 950 SVE2 窗口。

## 目标审计（2026-08-16，docs/56）

- [x] E2E 硬指标未达成（-1.9% vs -15%，差距 ~13pp）；
