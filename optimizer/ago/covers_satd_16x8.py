"""Bounded cover search for satd 16x8 (AGO M3, docs/82 下一步 #4 扩展).
...
is best_ir_sve16 (dual-group, permute_ratio=46.7% — over the 30%
...
def emit_cover(cover: str, func_name: str = "dynopt_satd_16x8_sve2") -> str:
