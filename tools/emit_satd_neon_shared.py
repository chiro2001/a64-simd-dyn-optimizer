...
def emit_8x8(func_name="dynopt_satd_8x8_sve2", reduce="vaddlv",
    ...
    if abs_kind not in ("abd", "subabs"):
        raise ValueError("unknown abs_kind %r" % abs_kind)
    ...
    if abs_kind == "abd":
        abs_body = ("    *sum = vabsq_s16(vaddq_s16(a, b));\n"
                    "    *sub = vabdq_s16(a, b);")
    else:
        abs_body = ("    *sum = vabsq_s16(vaddq_s16(a, b));\n"
...
// SATD 8x8 pure NEON, reduce=%(reduce)s abs=%(abs)s.
#include <arm_neon.h>
#include <stdint.h>
...
""" % {"reduce": reduce, "func": func_name, "red": red,
       "abs": abs_kind, "abs_body": abs_body}
